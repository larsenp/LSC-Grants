...
//	Modified by Peter Larsen 10/31/2013
	...
	var imgDir = "../../../Core/Images/DateTextBox/"	// directory for images ... e.g. var imgDir="/img/"
	...
	var	yearNow	 = today.getFullYear() //LSC replacement of deprecated call to getYear()
    ...
    */
	...
	function init()	{
		...
		if (!ns4)
		{
			//if (!ie) { yearNow += 1900	} **date adjustment no longer needed because yearNow is set using getFullYear
			...
			sHTML2= "<a href='javascript:hideCalendar()'><IMG SRC='"+imgDir+"close.gif' WIDTH='15' HEIGHT='13' BORDER='0' ALT='Close the Calendar'></a>"
            document.getElementById("closebutton").innerHTML  =	sHTML2
			bPageLoaded=true
		}
	}
