<%@ Control Language="vb" AutoEventWireup="true" CodeBehind="UploadNew_LSC.ascx.vb" Inherits="Core_Web.Controls.Base.cUploadNew_LSC" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" EnableViewState="true" %>
...
<table border='0' cellspacing='0' cellpadding='2' runat='server' width='100%' ID='TblInstructions'>
	...
	<tr>
		<td>
			<ol>
			  <li runat='server' id='liTemplate1'>If available, download the template and save the file to your computer</li>
			  <li runat='server' id='liTemplate2'>Open the file and enter the required information. Refer to the guidelines for more information</li>
			  <li runat='server' id='liTemplate3'>Save the file on your computer in one of the formats specified below</li>
			  <li>In the <b>Upload</b> section, click <b>Browse</b> to find the file on your computer</li>
			  <li>After the file name appears in the text box, click <b>Upload</b></li>
			  <li>Click <b>View</b> to view the document to verify it was accepted by the system. If the system encountered errors saving your document, they will appear in the new window</li>
		  </ol>
		</td>
	</tr>
</table>
...
<table id="Table5" cellpadding='0' cellspacing='0' border='0' runat='server'>
