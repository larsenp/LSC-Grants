<%@ Control Language="vb" AutoEventWireup="true" CodeBehind="DateTextBoxCalendar_LSC.ascx.vb" Inherits="Core_Web.Controls.Base.cDateTextBoxCalendar_LSC" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
