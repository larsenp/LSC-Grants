...
<span id='spnConfigXML' visible='false' runat='server'>
	<ModuleSection>
		...
		<DataObject Key='LscTigBudgetLine' DataObjectDefinitionKey='LscTigBudgetLine' Updatable='True' CreateNew='False'>
			<Filters>
				<Argument PropertyKey="LscTigBudgetLineID" Value="16" Operator='NotEqual'/>
			</Filters>
			<Sort>
				<Argument PropertyKey='LscTigBudgetLineID'/>
			</Sort>
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
					<Control ID='ctlBudgetItems'
						...
						DataPresenterID='DPL' 
						DataPresenterURL='Implementation/Modules/TIG_FinalBudget/Forms/FinalBudgetItem.ascx'/>
				</DisplayProperty>
		...
		<DataObject Key='LscTigBudgetItemCF_F' DataObjectDefinitionKey='LscTigBudgetItem' Updatable='True' CreateNew='False'>
			<Filters>
				...
				<Argument PropertyKey="LscTigBudgetLineID" Value="16">
