...
<table style="width:450px; padding:2px; vertical-align:top">
	<tr>
		<td style="width:250px">
			<span runat='server' id='spnBudgetLine'/>
		</td>
...
<span id='spnConfigXML' visible='false' runat='server'>
	<ModuleSection>
		<DataObject DataObjectSource='DataPresenterList' DataObjectSourceKey='LscTigBudgetLine' Key='LscTigBudgetLine' Updatable='False'/>
		...
		<DataObject Key='LscTigBudgetItemF' DataObjectDefinitionKey='LscTigBudgetItem' Updatable='True' CreateNew='False'>
			<Filters>
				...
				<Argument Type='DataObjectCollection' TypeKey='LscTigBudgetLine' DataObjectPropertyKey="LscTigBudgetLineID" PropertyKey="LscTigBudgetLineID">
					<RelatedProperty PropertyKey="LscTigBudgetLine"/>
				</Argument>
			</Filters>
			<DisplayProperties>
				<DisplayProperty PropertyKey='LscTigBudgetLine.Description'>
					<Control ID='spnBudgetLine'
