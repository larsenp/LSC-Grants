...
<table width='100%' >
    <tr><td>&nbsp;</td></tr>
    <tr>
      <td width='20%'><b> LSC President Renewal Recommendation:</b> </td>
      <td width='80%' align="left"><span runat='server' id='spnPresidentOutcome' /></td>
   </tr>
   <tr><td>&nbsp;</td></tr>
   <tr>
...
<table width="750" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr><td>&nbsp;</td></tr>
    <tr>
       <td><p>LSC uses the grant renewal process to be informed of any significant changes or unexpected developments in the grantee's delivery system, since the submission of the most recent competitive grant application, that adversely affect service delivery.   This document certifies that the LSC President met with OPP and OCE management and discussed the grant renewal evaluation and recommendation, special grant conditions (if applicable), and follow-up activity with Applicant (if applicable).  The renewal recommendation takes into consideration input from the Office of Compliance and Enforcement and the Office of the Inspector General.</p></td>
    </tr>
</table>
<br />
<table>
	   ...
	   <DataObject Key='LscRenewalRec' DataObjectDefinitionKey='LscRenewalRec' Updatable='False' CreateNew='False'>
			...
			<DisplayProperties>
	              <DisplayProperty PropertyKey='LscRenewalRecommendation.Description'>
					<Control ID='spnPresidentOutcome'
