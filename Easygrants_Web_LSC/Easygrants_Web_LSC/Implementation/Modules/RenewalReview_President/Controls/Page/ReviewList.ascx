...
<br />
<div class='SeparatorHdg'>Renewal Application Review - President</div>
	...
	<ModuleSection>
	    ...
	    <DataObject Key='LscToDoListRenewalAppReview' DataObjectDefinitionKey='LscToDoListRenewalAppReview' Updatable='True' CreateNew='False'>
			<Filters>
				...
				<Argument PropertyKey='WfTaskID' Value='57' />
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
				   <Control ID='ctlDPL' 
						...
						DataPresenterID='DPL' 
						DataPresenterURL='Implementation/Modules/RenewalReview_President/Controls/PageSection/ReviewListChild.ascx' />
				</DisplayProperty>
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
				   <Control ID='ctlDPLReviewsCompleted' 
						...
						Type='cDataPresenterList' 
						DataPresenterID='DPL' 
						DataPresenterURL='Implementation/Modules/Staff/Controls/Page/Reviews/RenewalAppReview_President_Child_ReadOnly.ascx' />
				</DisplayProperty>
			</DisplayProperties>
		</DataObject>--%>
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
					<Control ID='ctlDPLReviewsCompleted'
						...
						SeparatorWidth='2'
						MaxPerPage='15'
						NoRecordMessage='There are no current President Renewal Application Review items.'>
								...
								<Argument Value='CurrentDate' ValueKey='CloseDate' Operator='GreaterThanEqual' DisplayValue='Control' PropertyKey='RecipientID'>
									<Control ID='ctlLink2'
										...
										<Action
											...
											<Parameters>
												<Argument Value='PresidentRenewReview' />
											</Parameters>
										</Action>
									</Control>
								</Argument>
						...
						<DisplayProperty PropertyKey='WfTaskAssignment.LscRenewalRec.PrimaryReaderPerson.FirstNameLastName' ColumnHeader='President' />
