...
<table>
	<tr>
		...
		<td>
			<EasyGrants:cReportOutputLink id='ctlApplicantReportLinkOCEDir' runat='server'/>
		</td>
	</tr>
</table>
...
<span id='spnConfigXML' visible='false' runat='server'>
	<ModuleSection>
		...
		<DataObject Key='LscSubgrantWfTAsByStep' DataObjectDefinitionKey='LscSubgrantWfTAsByStep' Updatable='False' CreateNew='False'>
			<Filters>
				<Argument Type='ModuleUser' TypeKey='WfTaskAssignmentID' PropertyKey='OPPDWfTAID'/>
			</Filters>
		</DataObject>
		...
		<DataObject Key='LscSubgrantReviewDueDates' DataObjectDefinitionKey='LscSubgrantReviewDueDates' Updatable='False' CreateNew='False'>
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='OppDirectorReviewDue' Format='M/d/yyyy'>
		...
		<DataObject Key='ReportOutputLinkOCEDir' DataObjectDefinitionKey='WfTaskAssignment'>
			<Filters>
				<Argument Type='DataObjectCollection' TypeKey='LscSubgrantWfTAsByStep' DataObjectPropertyKey='OCEDWfTAID' PropertyKey='WfTaskAssignmentID'/>
			</Filters>
			<DisplayProperties>				
				<DisplayProperty PropertyKey='WfTaskAssignmentID'>
					<Control ID='ctlApplicantReportLinkOCEDir'
						Type='cReportOutputLink'
						DisplayText='~View OCE Director Review PDF~'>
						<Parameters>
							<Argument Type='DataObjectCollection'
								TypeKey='ReportOutputLinkOCEDir'
								DataObjectPropertyKey='WfTaskAssignmentID'
								PropertyKey='EntityID'
								Value=''/>
							<Argument Type='DataObjectCollection'
