...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
   <tr>
    <td><p>The <strong>Subgrant Summary</strong> page captures information  regarding the type(s) of services to be provided under the subgrant agreement  and the type of contract to be used (<em>i.e</em>.,  flat fee, fee for service, retainer, etc.).</p>
</td>
  </tr>
</table>
<br /><br />
