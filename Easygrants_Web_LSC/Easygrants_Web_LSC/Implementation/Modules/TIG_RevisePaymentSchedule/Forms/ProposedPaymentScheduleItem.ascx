		...
		<DataObject DataObjectSource='DataPresenterList' DataObjectSourceKey='AdditionalPayments' DataObjectDefinitionKey='LscTigProposedPaymentSchedule' Key='AdditionalPayments' Updatable='True'>
			<DisplayProperties>
				<DisplayProperty PropertyKey='PaymentNumber'>
					<Control ID='txtPaymentNumber'
						Type='cMoneyTextBox' 
						Container='spnPaymentNumber'
						AllowInputCommas='False'
						MaxInputDecimalPlaces='0'
						DecimalErrorMessage='Payment Number must be a whole number.'
						RegExErrorMessage='Payment Number must be a whole number.'
						MaxLength='2'
						Size='3' 
						MinimumValue='1'/>
				</DisplayProperty>
