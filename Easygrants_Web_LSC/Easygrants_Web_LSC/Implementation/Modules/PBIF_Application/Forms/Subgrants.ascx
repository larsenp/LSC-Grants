...
<div style="width:600px">
	...
	<ol>
		<li>
			Once you are in the&nbsp;<strong>Subgrants</strong>&nbsp;section of your LSC Grants PBIF application, click&nbsp;<strong>Browse</strong>&nbsp;to find the file(s) locally on your computer. You can upload files with extension types of .doc, .docx, .xls, .xlsx, .pdf, and .rtf only.
		</li>
		<li>
	...
	<div width='100%' class='SeparatorHdg'>Subgrants</div>
<br />
...
<ModuleSection>
	...
	<DataObject Key='WfProjectTaskUpload' DataObjectDefinitionKey='WfProjectTaskUpload' Updatable='False' CreateNew='False'>
		<Filters>
			...
			<Argument PropertyKey='UploadId' Value='65' />
		</Filters>
		<DisplayProperties>
		...
		<DisplayProperties>
			<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
				<Control ID='ctlFileList'
					...
					NoRecordMessage='No Subgrants have been uploaded for this application.'>
