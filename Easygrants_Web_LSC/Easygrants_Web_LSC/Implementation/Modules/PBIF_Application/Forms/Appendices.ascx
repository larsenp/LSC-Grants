...
<div style="width:600px">
	<p>Applicants may upload up to 30 pages of supporting documentation. Additional appendices and supporting documentation include documents such as maps, relevant data and statistical information, letters of commitment from key partners, and letters of support from community stakeholders. This may also include information on past projects and credentials of partners and other entities involved in the project.</p>
	<p>
		<span style="line-height:1.6">Letters of commitment are </span>
		<strong style="line-height:1.6">required</strong>
		<span style="line-height:1.6"> if there is a key partner whose participation is necessary for the completion of the project.</span>
		<span style="line-height:1.6">&nbsp;</span>
	</p>
	<ol>
		<li>
			Once you are in the&nbsp;<strong>Appendices and Supporting Documentation</strong>&nbsp;section of your LSC Grants PBIF application, click&nbsp;<strong>Browse</strong>&nbsp;to find the file(s) locally on your computer.
		</li>
		<li>
	...
	<div width='100%' class='SeparatorHdg'>Appendices and Supporting Documentation</div>
	<br />
...
<ModuleSection>
	...
	<DataObject Key='WfProjectTaskUpload' DataObjectDefinitionKey='WfProjectTaskUpload' Updatable='False' CreateNew='False'>
		<Filters>
			...
			<Argument PropertyKey='UploadId' Value='63' />
		</Filters>
		<DisplayProperties>
		...
		<DisplayProperties>
			<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
				<Control ID='ctlFileList'
					...
					NoRecordMessage='No Appendices and Supporting Documentation have been uploaded for this application.'>
