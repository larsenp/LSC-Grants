...
<div style='width:600px'>
	...
	<ol>
		<li>
			Once you are in this <strong>Contracts</strong> section of LSC Grants PBIF app;lication, click&nbsp;<strong>Browse</strong>&nbsp;to find the file on your computer. 
		</li>
		<li>
	...
	<div width='100%' class='SeparatorHdg'>Contracts</div>
<br />
...
<ModuleSection>
	...
	<DataObject Key='WfProjectTaskUpload' DataObjectDefinitionKey='WfProjectTaskUpload' Updatable='False' CreateNew='False'>
		<Filters>
			...
			<Argument PropertyKey='UploadId' Value='64' />
		</Filters>
		<DisplayProperties>
		...
		<DisplayProperties>
			<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
				<Control ID='ctlFileList'
					...
					NoRecordMessage='No Contracts have been uploaded for this application.'>
