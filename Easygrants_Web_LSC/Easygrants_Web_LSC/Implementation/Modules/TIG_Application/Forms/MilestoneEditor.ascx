...
<p>Please add discrete milestones for the specific activities that will be completed by the end of this payment period towards meeting the goal and objectives of the project. Please be sure to input each deliverable as a separate milestone in the online system. This is done using the <strong>“Add Milestone”</strong> button. <strong>DO NOT add more than one milestone in each milestone input box.</strong> For more information on payment schedules, go to <a href="http://tig.lsc.gov/grants/application-process" >http://tig.lsc.gov/grants/application-process</a> </p>
...
<span id='spnConfigXML' visible='false' runat='server'>
	<ModuleSection>
		<DataObject Key='LscMilestone' DataObjectDefinitionKey='LscMilestone' Updatable='True' CreateNew='True'>
			...
			<DefaultValues>
				<Argument Type='QueryString' TypeKey='LscTigProposedPaymentScheduleID' PropertyKey='LscTigProposedPaymentScheduleID' Update='False' Create='True' />
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='MilestoneNumber'>
					<Control ID='txtMilestoneNumber'
						...
						MaxLength='3'
						RequiredField='True'
						ErrorMessage='Milestone Number is required.'>
				...
				<DisplayProperty PropertyKey='Milestone'>
					<Control ID='txtMilestone'
						...
						Cols='60' 
						RequiredField='True'
						ErrorMessage='Milestone is required.'/>
				</DisplayProperty>
