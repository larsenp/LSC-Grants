...
<table border='0' cellspacing='0' cellpadding='2' width='100%'>
	...
	<tr>
		<td>
			In addition to the Project Narrative, a maximum of 32 total pages may be submitted to fully document 
			the proposal. The 32-page limit is inclusive of the Project Narrative Appendices, the Draft Evaluation 
			Plan, the Letters of Commitment from Key Partners and Letters of Support, which should be uploaded on 
			the appropriate sections of the application system. These four sections combined should not exceed 32 pages. 
		</td>
	</tr>	
	<tr><td>&nbsp;</td></tr>
	<tr>
		<td>
			The Appendices uploaded on this page may include documents such as timelines, technical diagrams, 
			organizational charts, maps, and résumés. This may also include information on past projects and 
			credentials of firms and outside consultants involved in the project. 
		</td>
	</tr>	
	<tr><td>&nbsp;</td></tr>
	<tr>
		<td>
			<ol>
			  <li>In the <b>Project Narrative Appendices</b> section, click <b>Browse</b> to find the file on your computer. You can upload files with extension types of .doc, .docx, .xsl, .xslx, .pdf, and .rtf only.</li>
	...
	<ModuleSection>
		...
		<DataObject Key='WfProjectTaskUpload' DataObjectDefinitionKey='WfProjectTaskUpload' Updatable='False' CreateNew='False'>
			<Filters>
				...
				<Argument PropertyKey='UploadId' Value='17' />
			</Filters>
			<DisplayProperties>
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
					<Control ID='ctlFileList'
						...
						NoRecordMessage='No Project Narrative Appendices have been uploaded.'>
