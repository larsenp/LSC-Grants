...
<b>PLEASE NOTE</b>: Some areas in the Validation Summary may be checked as complete even though you may need or wish to provide additional information. In particular, pages for which information is not required (e.g., “Letters of Support” for applicants in the Open, Replication, or Website Improvement and Innovation categories) will be checked as complete whether or not information is submitted. If you wish to provide such information in your application, check to ensure that you have done so before you submit the application.</p>
