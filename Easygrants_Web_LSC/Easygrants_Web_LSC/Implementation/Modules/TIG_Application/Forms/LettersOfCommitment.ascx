...
<table border='0' cellspacing='0' cellpadding='2' width='100%'>
	...
	<tr>
		<td>
			Please upload below letters of commitment to the project from any key partner whose participation is necessary for the completion of the initiative. 
		</td>
	</tr>
	<tr><td>&nbsp;</td></tr>
	<tr>
		<td>
			<ol>
			  <li>In the <b>Letters of Commitment</b> section, click <b>Browse</b> to find the file on your computer. You can upload files with extension types of .doc, .docx, .xsl, .xslx, .pdf, and .rtf only.</li>
...
<div width='100%' class='SeparatorHdg'>Letters of Commitment</div>
<br />
	...
	<ModuleSection>
		...
		<DataObject Key='WfProjectTaskUpload' DataObjectDefinitionKey='WfProjectTaskUpload' Updatable='False' CreateNew='False'>
			<Filters>
				...
				<Argument PropertyKey='UploadId' Value='18' />
			</Filters>
			<DisplayProperties>
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
					<Control ID='ctlFileList'
						...
						NoRecordMessage='No letters of commitment have been uploaded for this application.'>
