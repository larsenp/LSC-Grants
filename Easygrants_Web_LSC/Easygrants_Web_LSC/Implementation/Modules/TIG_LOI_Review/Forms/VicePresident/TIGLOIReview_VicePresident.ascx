...
<br /><br />
<div class='SeparatorHdg'>Comments from OPP Director</div>
<br />
...
<br />
<div class='SeparatorHdg'>Vice President's Review</div>
<br />
<b>Vice President's Decision</b><br />
<span runat='server' id='spnWfTaskOutcomeID'/><br /><br />

<b>Vice President's Comments</b><br />
	...
	<ModuleSection>
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='WfTaskOutcomeID'>
					<Control ID='ctlWfTaskOutcomeID'
						...
						<Filters>
							<Argument PropertyKey='WfTaskID' Value='92' />
					...
					<Control ID='lnkReturn'
						...
						<Action PostBack='True'
							...
							<Parameters>
								...
								<Argument Value='TIGLOIReview_O_R_WI_VicePresident' />
							</Parameters>
						</Action>	
					</Control>
				</DisplayProperty>
		...
		<DataObject Key='LscExternalReviewApplicationsList' DataObjectDefinitionKey='LscExternalReviewApplicationsList'>
			<Filters>
				...
				<Argument PropertyKey='RevWfTaskID' Value='70'/>
