...
<br />
<div class='SeparatorHdg'>Pro Bono Innovation Fund LOI Review - President</div>
	...
	<ModuleSection>
	    ...
	    <DataObject Key='LscToDoListProBonoAppReviewDetail' DataObjectDefinitionKey='LscToDoListProBonoAppReviewDetail' Updatable='True' CreateNew='False'>
			<Filters>
				...
				<Argument PropertyKey='WfTaskID' Value='127' />
			...
			<Sort>
				<Argument PropertyKey='LoiScore' Direction='Descending'/>
			</Sort>
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
				   <Control ID='ctlDPL' 
						...
						DataPresenterID='DPL' 
						DataPresenterURL='Implementation/Modules/PBIF_LOIReview_President/PageSection/ReviewListChild.ascx' />
				</DisplayProperty>
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
					<Control ID='ctlDPLReviewsCompleted'
						...
						SeparatorWidth='2'
						MaxPerPage='15'
						NoRecordMessage='There are no submitted President LOI Review items.'>
						...
						<DisplayProperty PropertyKey='WfTaskAssignment.SubmittedDate' ColumnHeader='Submitted Date' Format='MM/dd/yyyy' />
