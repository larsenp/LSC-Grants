...
<br />
<div class='SeparatorHdg'>Competitive Application Review - President</div>
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
				   <Control ID='ctlDPL' 
						...
						DataPresenterID='DPL' 
						DataPresenterURL='Implementation/Modules/ApplReview_President/Controls/PageSection/ReviewListChild.ascx' />
				</DisplayProperty>
								...
								<Argument Value='CurrentDate' ValueKey='CloseDate' Operator='GreaterThanEqual' DisplayValue='Control' PropertyKey='RecipientID'>
									<Control ID='ctlLink2'
										...
										<Action
											...
											<Parameters>
												<Argument Value='PresidentCompReview' />
											</Parameters>
										</Action>
									</Control>
								</Argument>
