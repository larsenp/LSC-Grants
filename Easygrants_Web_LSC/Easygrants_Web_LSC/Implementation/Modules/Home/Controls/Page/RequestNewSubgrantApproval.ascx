...
<div class='SeparatorHdg'>
	Create New Subgrant Approval Request
</div>

<p>
	To create a new subgrant approval request, provide the start and end date for the proposed subgrant, then click <b>Save and Continue</b>.
</p>
	...
	<ModuleSection>
		...
		<DataObject Key='GranteeProject' DataObjectDefinitionKey='GranteeProject' Updatable='True' CreateNew='True'>
			...
			<DefaultValues>
				...
				<Argument PropertyKey='WfProjectID' Value='2810' />
					...
					<Control ID='btnSaveContinue'
						...
						<%--<Action PostBack='True'
							...
							<Parameters>
								...
								<Argument Value='RequestSubgrantApproval53Config' />
								<Argument Value='' />
								<Argument Type='Control' TypeKey='WfTaskAssignment' DataObjectPropertyKey='WfTaskAssignmentID' PropertyKey='WfTaskAssignmentID' />
							</Parameters>
						</Action>--%>
					</Control>
				</DisplayProperty>
