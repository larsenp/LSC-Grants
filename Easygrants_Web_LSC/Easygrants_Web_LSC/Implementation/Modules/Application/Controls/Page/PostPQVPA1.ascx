			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
					<Control ID='lstCharts'
						...
						<HeaderHtml>
							RFP Charts Related To Performance Area One
						</HeaderHtml>
