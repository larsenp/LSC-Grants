...
<div style='width:600' >
	...
	<br />
<p>
<div class='SeparatorHdg'>Performance Area Four</div>
<i>Effectiveness of governance, leadership and administration (i.e., board governance; leadership; overall management and administration; financial administration; human resources administration; internal communication; general resource development and maintenance; and participation in an integrated legal services delivery system).</i>
</p>
...
<b>Performance Area Four: </b>Significant changes or major developments in the delivery system since the PQV ended, and those anticipated during the grant year.<span style="color:red">*</span>
<br /><br />
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
					<Control ID='lstCharts'
						...
						<HeaderHtml>
							RFP Charts Related To Performance Area Four
						</HeaderHtml>
