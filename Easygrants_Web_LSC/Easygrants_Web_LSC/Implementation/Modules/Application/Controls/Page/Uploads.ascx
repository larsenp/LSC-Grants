...
<table id="Table2" border='0' cellspacing='0' cellpadding='0' runat='server' width='600' >
	<tr><td colspan="4" ><p>The  uploads listed in the <strong>Upload Checklist</strong> below are required for this application.  To upload a document:</p>
	    <ol>
         ...
         <p><span runat='server' id='spnGrantAssurancesFormCInstructions' /></p>
		 <p><span runat='server' id='spnApplicantCertificationFormIInstructions' /></p>
         </td>
