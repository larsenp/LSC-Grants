...
<span id='spnConfigXML' visible='false' runat='server'>
	<ModuleSection>
		...
		<DataObject Key='LscExpenditureByTypeA' DataObjectDefinitionKey='LscExpenditureByTypePai' Updatable='True' CreateNew='True'>
			<Filters>
			...
			<DisplayProperties>
				...
				<DisplayProperty PropertyKey='LscExpenditureByTypeSecAPercentPai.PercentByType' Format='#0'>
