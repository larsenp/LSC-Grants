...
<table width='100%' cellpadding='0' cellspacing='0'>
	<tr>
		...
		<td align='left' width='30%' style='border-bottom-style:solid;border-bottom-width:1px'>
			<b>4. Total</b><br />
			<i>(Total should equal total LSC expenses from Form D-12): <b><span runat='server' id='spnTotalD12' /> $ </b></i>
		</td>
...
<span id='spnConfigXML' visible='false' runat='server'>
	<ModuleSection>
		...
		<DataObject  Key='WfTATopLevelBudgetItems' DataObjectDefinitionKey='WfTATopLevelBudgetItems' Updatable='False' CreateNew='False'>
				<Filters>
					<Argument Type='ModuleUser' TypeKey='WfTaskAssignmentID' PropertyKey='WfTaskAssignmentID'/>
					<Argument PropertyKey='CategoryTypeID' Value='1'/>
				</Filters>
			<DisplayProperties>	
				<DisplayProperty PropertyKey='BudgetItem.LscBudgetItem.LscExpenditures'>
					<Control ID='spnTotalD12'
						Type='HtmlGenericControl' />
				</DisplayProperty>
			</DisplayProperties>
		</DataObject>
