<%@ Control Language="vb" AutoEventWireup="true" Inherits="Implementation.Modules.Application.Controls.PageSection.cCurrentExpensesEditor" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<table width='600' border="0" cellpadding="0" cellspacing="0">
		    <tr>
		      <td><h1>Current Year Expenses (D-2)</h1></td>
  </tr>
		    <tr>
		      <td><table id="Table_Instructions" border='0' cellspacing='0' cellpadding='0' runat='server' width='600'>
                ...
                <tr>
                  <td valign="top" ><p>This <strong>Current Year Expenses (D-2)</strong> page captures projected non-LSC expenses for the current year. </p>
                      <ul>
                        <li><strong><font color="#990000">All applicants who are not current recipients of LSC funds must complete Current Year Expenses (D-2). </font></strong></li>
                        ...
                        <li>Calculate total projected expenses for the current year based on the most current data available. </li>
                        <li>Do not include expenses related to donated services (e.g., volunteer attorney time, donated office equipment). </li>
                        <li>Complete this form based on applicant's best estimate of expenses that will be incurred in providing services to low-income clients. </li>
                        <li>Report total projected expenses for  the current year from the following sources of non-LSC funding: </li>
                        <blockquote>
                          <p><strong>Title XX of the Social Security Act, Older Americans Act, Violence Against Women, Other Federal Grants, Community Development Block Grants, State Grants, Local Grants, United Way Grants, Foundation Grants, Bar Association Grants, IOLTA, Attorney Fee Awards, Carryover Funds, Publication Income, and Other Non-LSC funds</strong> </p>
                        </blockquote>
                        <li>Law firms and governmental entity applicants should include expenses incurred against public or private grants or contracts to serve low-income clients. </li>
...
<table border='0' cellspacing='0' cellpadding='0' runat='server' width='600'>
	<tr>
		<td	width='20%'><b>Service Area</b></td>
	...
	<ModuleSection>
		...
		<DataObject Key='TopBudgetCategory' DataObjectDefinitionKey='BudgetCategory' Updatable='False' CreateNew='False'>
		  <Filters>
				...
				<Argument PropertyKey='CategoryTypeID' Value='3' />
