...
In the comment box below, provide a description of any changes made, or indicate that no changes were necessary.<br />
...
<span id='spnConfigXML' visible='false' runat='server'>
	<ModuleSection>
		<DataObject Key='WfTaskAssignmentRequest' DataObjectDefinitionKey='WfTaskAssignment' Updatable='False' CreateNew='False'>
			<Filters>
				<Argument Type='ModuleUser' TypeKey='GranteeProjectID' PropertyKey='GranteeProjectID'/>
				<Argument Group='('/>
					<Argument PropertyKey='WfTaskID' Value='53' Bool=''/>
					<Argument PropertyKey='WfTaskID' Value='104' Bool='Or'/>
				<Argument Group=')' Bool=''/>
			</Filters>
		</DataObject>

		<DataObject Key='LscCopySubgrantAgreementIndexCheck' DataObjectDefinitionKey='LscCopySubgrantAgreementIndexCheck' Updatable='False' CreateNew='False'>
			<Filters>
				<Argument Type='DataObjectCollection' TypeKey='WfTaskAssignmentRequest' DataObjectPropertyKey='WfTaskAssignmentID' PropertyKey='source_wfta_id'/>
				<Argument Type='ModuleUser' TypeKey='WfTaskAssignmentID' PropertyKey='target_wfta_id'/>
			</Filters>
		</DataObject>
