...
<div style="width:600px;">
	...
	<br />
	<div class="SeparatorHdg">Upload Conflicts of Interest form</div>
	<p>Upload the executed LSC Disaster Grant Conflict of Interest Form as a PDF file.</p>
	<span runat='server' id='spnUploadConflict' />
	<br />
	<span runat='server' id='spnFileListConflict' />
	<br />
    ...
    <ModuleSection>
		...
		<DataObject Key='WfProjectTaskUpload' DataObjectDefinitionKey='WfProjectTaskUpload' Updatable='False' CreateNew='False'>
			<Filters>
				...
				<Argument PropertyKey='UploadId' Value='49' />
			</Filters>
			<DisplayProperties>
       ...
       <DataObject Key='SubmittedFile' DataObjectDefinitionKey='SubmittedFile' Updatable='False' CreateNew='False' >
		...
		<DataObject Key='WfProjectTaskUploadConflict' DataObjectDefinitionKey='WfProjectTaskUpload' Updatable='False' CreateNew='False'>
			<Filters>
				<Argument Type='DataObjectCollection' TypeKey='WfTaskAssignment' DataObjectPropertyKey='WfProjectTask.WfProjectTaskID' PropertyKey='WfProjectTaskID' />
				<Argument PropertyKey='UploadId' Value='51' />
			</Filters>
			<DisplayProperties>
				<DisplayProperty PropertyKey=''>
					<Control ID='ctlUploadConflict'
						Type='cLSCUpload'
						Container='spnUploadConflict'>
						<Properties>
							<Argument Type='ModuleUser' TypeKey='WfTaskAssignmentID' PropertyKey='EntityID' />
							<Argument PropertyKey='EntityType' Value='WfTaskAssignment' />
							<Argument Type='DataObjectCollection' TypeKey='WfProjectTaskUploadConflict' DataObjectPropertyKey='WfProjectTaskUploadID' PropertyKey='WfProjectTaskUploadID'/>
							<Argument PropertyKey='DisplayErrorInValidationSummary' Value='True' />
						</Properties>
					</Control>
				</DisplayProperty>
       ...
       <DataObject Key='SubmittedFileConflict' DataObjectDefinitionKey='SubmittedFile' Updatable='False' CreateNew='False' >
			<Filters>
				<Argument Type='ModuleUser' TypeKey='WfTaskAssignmentID' PropertyKey='EntityID' />
				<Argument PropertyKey='UploadId' Value='51'>
					<RelatedProperty PropertyKey='TaskUploadType' />
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
					<Control ID='ctlFileListConflict'
						Type='cDataListCtl'
						Container='spnFileListConflict'
						NoRecordMessage='The executed LSC Disaster Grant Conflict of Interest Form has not been uploaded.'>
						<DisplayProperty PropertyKey='SourceFileName' ColumnHeader='File Name' />
						<DisplayProperty PropertyKey='SubmitDate' ColumnHeader='Uploaded' Format='M/d/yyyy h:mm tt' />
						<DisplayProperty PropertyKey='' DataAlign='Center'>
							<Control ID='btnDelete'
