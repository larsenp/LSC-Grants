...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
   <tr>
    <td><p>The <strong>Subrecipient Profile</strong> page captures information regarding the proposed subrecipient program including its full name and mailing address, the name of the  Executive Director, and their telephone and email address.  This page also captures information related to the counties or other geographical areas to be served by the subrecipient, the purpose of the subgrant, information regarding any fund balance which may exist and the number of cases closed by the subrecipient for the two year period prior to this application, as well as information regarding the type of oversight the recipient will maintain over the subrecipient.</p>
        <p>To assist recipients to accurately complete the online application, LSC recommends that recipients review the Subrecipient Profile form formerly used in conjunction with submitting subgrant agreements for approval prior to completing the online application.  A copy of the Subrecipient Profile form can be found on LSC’s Recipient Information Network.</p>
    </td>
  </tr>
</table>
<br /><br />
