...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
   <tr>
    <td><p>The <strong>Subrecipient Summary</strong> page captures information regarding the type(s) of services to be provided under the subgrant agreement and the target group(s) which will be the beneficiary of these services.</p>
    </td>
  </tr>
</table>
<br /><br />
...
<table width='400px' cellpadding='1'>
	...
	<tr>
		<td>
			<b>State Support Activities?<%=kDenoteRequiredField%></b>
		</td>
		<td>
			<span runat='server' id='spnStateSupportAct' />
		</td>
	</tr>
</table>
<br />
...
<div class='SeparatorHdg'>
	Target Group<%=kDenoteRequiredField%>
</div>
<br />
<span runat='server' id='spnLscSubgrantTargetedGroup' />
<br />
	If Other, what target group is anticipated?
<br />
<span runat='server' id='spnOtherTargetedGroup'/>
	...
	<ModuleSection>
		<DataObject Key='LscWfTASubgrant' DataObjectDefinitionKey='LscWfTASubgrant' Updatable='True' CreateNew='True'>
			...
			<DisplayProperties>
				...
				<DisplayProperty PropertyKey='StateSupportAct'>
					<Control ID='ctlStateSupportAct'
						Type='cRadioButtonList'
						Container='spnStateSupportAct'
						LoadParam='True'
						RepeatDirection='Horizontal'
						RepeatColumns='0'>						
						<Parameters>
				...
				<DisplayProperty PropertyKey='OtherTargetedGroup'>
					<Control ID='txtOtherTargetedGroup'
						Type='cTextArea'
						Container='spnOtherTargetedGroup'
						Cols='50'
						Rows='3'/>
				</DisplayProperty>
		...
		<DataObject Key='WfTaskAssignment' DataObjectDefinitionKey='WfTaskAssignment' Updatable='True' CreateNew='False'>
			...
			<DisplayProperties>
				...
				<DisplayProperty PropertyKey='LscSubgrantTargetedGroup'>
					<Control ID='ctlLscSubgrantTargetedGroup'
						Container='spnLscSubgrantTargetedGroup'
						Type='cCheckBoxList'
						DataObjectDefinitionKey='LscSubgrantTargetGroup'
						DisplayValue='AbbrDescription'
						StoredValue='LscSubgrantTargetGroupID'
						RepeatColumns='0'
						CellSpacing='2'
						RepeatDirection='Vertical'>
						<DefaultValues>
				...
				<%--<DisplayProperty PropertyKey='LscSubgrantContractType'>
					<Control ID='ctlLscSubgrantContractType'
						Container='spnLscSubgrantContractType'
						Type='cCheckBoxList'
						DataObjectDefinitionKey='LKPLscSubgrantContractType'
