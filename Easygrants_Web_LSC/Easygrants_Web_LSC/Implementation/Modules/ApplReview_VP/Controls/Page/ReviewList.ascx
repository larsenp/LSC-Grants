...
<br />
<div class='SeparatorHdg'>Competitive Application Review - Vice President</div>
...
<table width='900'>
	...
	<tr>
		<td colspan="7"class='MinorSeparatorHdg'>&nbsp;</td>
	</tr>
</table>
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
				   <Control ID='ctlDPL' 
						...
						DataPresenterID='DPL' 
						DataPresenterURL='Implementation/Modules/ApplReview_VP/Controls/PageSection/ReviewListChild.ascx' />
				</DisplayProperty>
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
					<Control ID='ctlDPLReviewsCompleted'
						...
						SeparatorWidth='2'
						MaxPerPage='15'
						NoRecordMessage='There are no completed Vice President Competitive Application Review items.'>
						...
						<DisplayProperty PropertyKey='WfTaskAssignment.LscOA1.StaffReaderPerson.FirstNameLastName' ColumnHeader='Vice President' />
