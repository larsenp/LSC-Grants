...
<Core:cUserCtlLoader ID="CUserCtlLoader1" CtlID='ctlAppInfo'
	Src='Implementation/Modules/ApplReview_VP/Controls/PageSection/ApplicantInformation.ascx'
	runat='server'/>
<br />
...
<table width='100%' >
   <tr>
      <td width='20%'><b> Grant Amount</b> </td>
...
<table width='100%' cellpadding='1'>
    <tr>
     ...
     <tr><td>&nbsp;</td></tr>
     <tr>
       <td width='30%'><b>OPP Director review status:</b></td> 
       <td width='30%' align="left"> <span runat='server' id='spnOPPDirStatus' /></td> 
       <td width='40%'>&nbsp;</td>  
    </tr>
</table>
<br />
...
<table width='100%' >
   ...
   <tr>
      ...
      <td align="left"><span runat='server' id='spnOCEDirFundRec' /></td>
      <td>&nbsp;</td>
   </tr>
   <tr><td>&nbsp;</td></tr>
    <tr>
      <td><b> OCE Director review status:</b> </td>
      <td align="left"><span runat='server' id='spnOCEDirStatus' /></td>
      <td>&nbsp;</td>
   </tr>
   <tr><td>&nbsp;</td></tr>
    <tr>
...
<br />
<div width='100%' class='SeparatorHdg'>
	Vice President for Grant Management Review
</div>
<br />
<table width='100%' cellpadding='1'>
    <tr>
       <td width='30%'><b>LSC Vice President for Grants Management Grant Award Recommendation:<%=kDenoteRequiredField %></b></td> 
       <td width='70%' align="left"> <span runat='server' id='spnVPOutcome' /></td> 
    </tr>
    <tr><td>&nbsp;</td></tr>
    <tr>
       <td width='30%'><b>LSC Vice President for Grants Management Funding Term Recommendation:<%=kDenoteRequiredField %></b></td> 
       <td width='70%' align="left"> <span runat='server' id='spnVPFundingTerm' /></td> 
    </tr>
    <tr><td>&nbsp;</td></tr>
    <tr>
      <td width='30%'><b> Special grant conditions (SGCs)<%=kDenoteRequiredField %></b> </td>
      <td width='70%' align="left"><span runat='server' id='spnVPSpecialGrant' /></td>
   </tr>
</table>
<br />
<table width="750" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td> Optional comment from the Vice President for Grants Management:</td>
    </tr>
    <tr>
    ...
    <tr><td>&nbsp;</td></tr>
    <tr>
       <td><p>This document certifies that the LSC Vice President for Grants Management met with OPP and OCE management and discussed: (1) grant application, (2) application evaluation, (3) program planning and assessment instrument (PPA), (4) special grant conditions (if applicable), (5) significant compliance and/or fiscal issues (if applicable), (6) significant audit issues (if applicable), (7)TIG status reports (if applicable), (8) PBIF status reports (if applicable), (9) PAI waiver request status reports (if applicable), (10) fund balance waiver requests status reports (if applicable), (11) follow-up activity with Applicant (if applicable), and (12) the funding recommendation. The grant application evaluation is based on the ABA Standards for the Provision of Civil Legal Aid, the LSC Performance Criteria, LSC regulations and the RFP. The funding recommendation is based on overall programmatic quality as determined by LSC's review of the grant application, fiscal and compliance reviews conducted by the Office of Compliance and Enforcement, input from the Office of the Inspector General, and other pertinent factors.</p></td>
    </tr>
    <tr><td>&nbsp;</td></tr>
    <tr><td>&nbsp;</td></tr>
</table>
<table>
    <tr>
      <td width='20%' align=left><b> LSC Vice President for Grants Management:<%=kDenoteRequiredField %></b></td>
              ...
              <td><p><b>Note</b></p>
                 <ul>
                      ...
                      <ul>
                          ...
                          <li>Fund Balance Waiver Request status reports, if applicable (Box)<br />
                          </li>
                      </ul>     
                 </ul></td>
         </tr>
	...
	<ModuleSection>
	     <DataObject Key='StaffReviewWfTA' DataObjectDefinitionKey='WfTaskAssignment' Updatable='False' CreateNew='False'>
			<Filters>
				...
				<Argument Group='(' Bool='And'/>
					<Argument PropertyKey='WfTaskID' Value='5' Bool='' />
					<Argument PropertyKey='WfTaskID' Value='68' Bool='Or'/>
				<Argument Group=')' Bool=''/>
			</Filters>
			<DisplayProperties>
	     ...
	     <DataObject Key='OPPDirReviewWfTA' DataObjectDefinitionKey='WfTaskAssignment' Updatable='False' CreateNew='False'>
			...
			<DisplayProperties>
				...
				<DisplayProperty PropertyKey='WfTaskStatus.WfTaskStatusAbbr' >
					<Control ID='spnOPPDirStatus' Type='HtmlGenericControl' />
				</DisplayProperty>
     ...
     <DataObject Key='OCEReviewWfTA' DataObjectDefinitionKey='WfTaskAssignment' Updatable='False' CreateNew='False'>
			...
			<DisplayProperties>
				...
				<DisplayProperty PropertyKey='WfTaskStatus.WfTaskStatusAbbr' >
					<Control ID='spnOCEDirStatus' Type='HtmlGenericControl' />
				</DisplayProperty>
				<DisplayProperty PropertyKey='WfTaskOutcome.WfTaskOutcome' >
					<Control ID='spnOCEDirFundRec' Type='HtmlGenericControl' />
				</DisplayProperty>
				<%--<DisplayProperty PropertyKey='LscReviewApplication.ComplianceAuditIssueComment'>
	  ...
	  <DataObject Key='LscOA1' DataObjectDefinitionKey='LscOA1' Updatable='True' CreateNew='True'>
			...
			<DisplayProperties>
			    <DisplayProperty PropertyKey='StaffReaderPersonID'>
					<Control ID='ctlVicePresident' 
						Type='cDropDown' 
						Container='spnVicePresident'
