...
<span id='spnConfigXML' visible='false' runat='server'>
	<ModuleSection>
	    ...
	    <DataObject Key='WfTAVPReview' DataObjectDefinitionKey='WfTaskAssignment' Updatable='True' CreateNew='False'>
		   <Filters>
		   ...
		   <DisplayProperties>
		        <DisplayProperty PropertyKey='WfTaskOutcomeID'>
					<Control ID='ctlWfTaskOutcomeID'
						...
						<Filters>
							<Argument Type='DataObjectCollection' TypeKey='WfTAVPReview' DataObjectPropertyKey='WfTaskID' PropertyKey='WfTaskID' />
