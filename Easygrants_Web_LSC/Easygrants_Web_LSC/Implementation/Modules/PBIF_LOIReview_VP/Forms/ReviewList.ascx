...
<br />
<div class='SeparatorHdg'>Pro Bono Innovation Fund LOI Review - Vice President</div>
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
				   <Control ID='ctlDPL' 
						...
						DataPresenterID='DPL' 
						DataPresenterURL='Implementation/Modules/PBIF_LOIReview_VP/PageSection/ReviewListChild.ascx' />
				</DisplayProperty>
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
					<Control ID='ctlDPLReviewsCompleted'
						...
						SeparatorWidth='2'
						MaxPerPage='15'
						NoRecordMessage='There are no submitted Vice President LOI Review items.'>
