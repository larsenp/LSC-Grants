...
<p>
Click the <b>View PDF</b> button below to view the Renewal Staff Review PDF of this grant.
</p>
					...
					<Control ID='btnReviewSummary'
						...
						Caption='Review Summary'>
							<Action PostBack='False'
								URL='/Easygrants_Web_LSC/Implementation/Modules/RenewalReview/ModuleContent.aspx?Config=RenewalReviewModuleConfig&amp;amp;Page=ReviewSummary&amp;amp;PageFrame=Print'
								Target='_blank'/>
					</Control>
				</DisplayProperty>
			</DisplayProperties>--%>
