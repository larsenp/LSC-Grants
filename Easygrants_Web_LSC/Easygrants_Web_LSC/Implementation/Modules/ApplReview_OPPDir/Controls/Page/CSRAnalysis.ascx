...
<table width='600px' cellpadding='1'>
	...
	<tr>
		<td>
			<b>4. # of PAI cases <span runat='server' id='spnCurrentYearPAI' /></b>
		</td>
		<td style="text-align:center">
			<span runat='server' id='spnPAICasesCurrent' />
		</td>
		<td style="background-color:Gray" />
		<td style="background-color:Gray" />
	</tr>
	<tr>
		<td>
			<b>5. Cases per 10,000 poverty population</b>
		</td>
		<td style="text-align:center">
	...
	<tr>
		<td>
			<b>6. Extended cases per 10,000 poverty population</b>
		</td>
		<td style="text-align:center">
	...
	<tr>
		<td>
			<b>7. Contested cases per 10,000 poverty population</b>
		</td>
		<td style="text-align:center">
	...
	<tr>
		<td>
			<b>8. PAI Cases per 10,000 poverty population</b>
		</td>
		<td style="text-align:center">
	...
	<tr>
		<td>
			<b>9. Percentage of non-LSC funding<span style='font-size:75%; vertical-align:super'>(1)</span></b>
		</td>
		<td style="text-align:center">
...
<br />Comment below is required if "Yes" has been selected for item c above.
...
5. Briefly explain conclusions. For those programs outside the 70% of median or average provide a summary assessment of the applicant's CSRs. <span style="color:red">*</span><br />
...
<span id='spnConfigXML' visible='false' runat='server'>
	<ModuleSection>
		<DataObject Key='WfTaskAssignmentReview' DataObjectDefinitionKey='WfTaskAssignment' Updatable='False' CreateNew='False'>
			<Filters>
        ...
        <DataObject Key='LscCsrAnalysisByRecipient' DataObjectDefinitionKey='LscCsrAnalysisByRecipient' Updatable='False' CreateNew='False'>
			<Filters>
				<Argument Type='DataObjectCollection' TypeKey='WfTaskAssignmentReview' DataObjectPropertyKey='GranteeProject.PrimaryOrganization.LegacyOrganizationID' PropertyKey='recipient_id' />
				<Argument Type='DataObjectCollection' TypeKey='WfTaskAssignmentReview' DataObjectPropertyKey='WfTACompetitionYear.WfTAYear' PropertyKey='year' />
			</Filters>
			<DisplayProperties>
		...
		<DataObject Key='LscReviewApplication' DataObjectDefinitionKey='LscReviewApplication' Updatable='False' CreateNew='False'>
			<Filters>
				<Argument Type='DataObjectCollection' TypeKey='WfTaskAssignmentReview' DataObjectPropertyKey='WfTaskAssignmentID' PropertyKey='WfTaskAssignmentID' />
			</Filters>
