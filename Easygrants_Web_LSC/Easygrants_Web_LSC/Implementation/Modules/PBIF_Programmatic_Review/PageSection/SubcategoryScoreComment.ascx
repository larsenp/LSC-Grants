...
<table style="width:100%">
	<tr>
		<td colspan='2' class='MinorSeparatorHdg'>
			<span runat='server' id='spnAbbr'/> Score (<span runat='server' id='spnWeighting'/>%)
		</td>
	</tr>
	<tr>
	...
	<ModuleSection>
		...
		<DataObject Key='LscProBonoReviewScore' DataObjectDefinitionKey='LscProBonoReviewScore' Updatable='True' CreateNew='True'>
			<Filters>
				...
				<Argument Type="DataObjectCollection" TypeKey="LscProBonoSubcategory" DataObjectPropertyKey='LscProBonoSubcategoryID' PropertyKey="LscProBonoSubcategoryID"/>
			</Filters>
			<DefaultValues>
				<Argument Type="ModuleUser" TypeKey="WfTaskAssignmentID" PropertyKey="WfTaskAssignmentID"/>
				<Argument Type="DataObjectCollection" TypeKey="LscProBonoSubcategory" DataObjectPropertyKey='LscProBonoSubcategoryID' PropertyKey="LscProBonoSubcategoryID"/>
