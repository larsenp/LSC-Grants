			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
					<Control ID='lstContractSubgrantDocs'
						...
						NoRecordMessage='No contract or subgrant documents were uploaded.'>
