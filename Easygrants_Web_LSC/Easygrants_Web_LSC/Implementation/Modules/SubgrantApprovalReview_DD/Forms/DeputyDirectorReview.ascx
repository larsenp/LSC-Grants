...
<Core:cUserCtlLoader CtlID='ctlSubgrantInfo' 
	Src='Implementation/Modules/SubgrantApprovalReview_DD/PageSection/SubgrantRequestInformation.ascx'
	runat='server'/>
...
<p>
	...
	section, labeled "Deputy Director Review Findings", and a second section which varies depending on which
	selection has been made on the Recommendation question. In some cases, if you change data in both the "Deputy 
...
<div class='SeparatorHdg'>Deputy Director Review Findings</div>
...
<Core:cUserCtlLoader CtlID='ctlFullApproval' 
	Src='Implementation/Modules/SubgrantApprovalReview_DD/PageSection/FullApproval.ascx'
	runat='server'/>

<Core:cUserCtlLoader CtlID='ctlPartialProvisionalApproval' 
	Src='Implementation/Modules/SubgrantApprovalReview_DD/PageSection/PartialProvisionalApproval.ascx'
	runat='server'/>

<Core:cUserCtlLoader CtlID='ctlDenial'
	Src='Implementation/Modules/SubgrantApprovalReview_DD/PageSection/Denial.ascx'
	runat='server'/>
<br />
