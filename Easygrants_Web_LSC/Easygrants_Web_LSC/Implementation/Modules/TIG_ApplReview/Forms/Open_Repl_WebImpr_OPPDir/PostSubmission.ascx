...
<table cellpadding='1'>
	<tr>
		...
		<td>
			<span runat='server' id='spnLscTigFundingRecommendation' />
		</td>
	</tr>
	<tr><td>&nbsp;</td></tr>
	<tr>
...
<span id='spnConfigXML' visible='false' runat='server'>
	<ModuleSection>
        ...
        <DataObject Key='LscTigReviewOpenRepWebImpr' DataObjectDefinitionKey='LscTigReviewOpenRepWebImpr' Updatable='True' CreateNew='True'>
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='LscTigFundingRecommendation.Description'>
					<Control ID='spnLscTigFundingRecommendation'
						Type='HtmlGenericControl' />
				</DisplayProperty>
