...
<Core:cUserCtlLoader ID="CUserCtlLoader1" CtlID='ctlOPPDirReview' 
	Src='Implementation/Modules/TIG_ApplReview/PageSection/OPPDirReview_Website.ascx'
	runat='server'/>
<br>

<Core:cUserCtlLoader ID="CUserCtlLoader3" CtlID='ctlVPReview' 
	Src='Implementation/Modules/TIG_ApplReview/PageSection/VPReview_Website.ascx'
	runat='server'/>
<br>
<table id="Table8" border='0' cellspacing='0' cellpadding='0' runat='server' width='100%'>
	<tr>
		<td  class="SeparatorHdg" colspan='2'><b>Funding Decision and Comments</b></td>
	</tr>	
	<tr><td>&nbsp;</td></tr>
	<tr>
	...
	<tr>
        <td valign="top" width='15%'><b>Funding Decision</b><%=kDenoteRequiredField%></td>
