...
<table id="Table1" border='0' cellspacing='0' cellpadding='2' runat='server' width='100%'>
  ...
  <tr>
    <td><h1>Upload Form L: Service Narrative </h1></td>
  </tr>
   <tr>
		<td>
...
<ModuleSection>
	<DataObject Key='SubmittedFile' DataObjectDefinitionKey='SubmittedFile' Updatable='True' CreateNew='True'>
			...
			<DefaultValues>
				...
				<Argument Type='DataPresenter' TypeKey='PersonID' PropertyKey='UploadedByID' />
				...
				<DisplayProperty PropertyKey=''>
					<Control ID='ctlUpload'
						...
						<Parameters>
							...
							<Argument Type='DataPresenter' TypeKey='WfTaskAssignmentID' PropertyKey='EntityAssocID' Bool=''/>
