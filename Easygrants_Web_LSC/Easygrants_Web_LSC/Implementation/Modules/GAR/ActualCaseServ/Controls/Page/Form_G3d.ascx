...
<table width="600"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><h1>Form G-3(d): Actual Case Services (PAI)</h1></td>
  </tr>
  <tr>
...
<table>
	...
	<tr>
		...
		<td>
			...
			cases already reported to LSC and excluding cases ineligible for reasons other than client financing eligibility)
		</td>
		<td>
