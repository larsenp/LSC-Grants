...
<table width="600"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><h1>Form G-5: Actual Open Cases (Staff)</h1></td>
  </tr>
  <tr>
...
<br />
<Core:cUserCtlLoader ID="CUserCtlLoader2" CtlID='ctlFormG5' 
	Src='Implementation/Modules/GAR/ActualOpenCases/Controls/PageSection/FormG5_Instruct.ascx'
	runat='server' />
<br />
<Core:cUserCtlLoader ID="CUserCtlLoader1" CtlID='ctlFormG5F' 
...
<Core:cUserCtlLoader CtlID='ctlEditor' 
	Src='Implementation/Modules/GAR/ActualOpenCases/Controls/PageSection/ActualOpenCasesEditor.ascx'
	runat='server'/>
<br />
<table width='600'>
	<tr>
