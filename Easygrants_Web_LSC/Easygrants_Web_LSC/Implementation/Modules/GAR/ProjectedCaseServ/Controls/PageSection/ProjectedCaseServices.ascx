...
<%--Core_Web.Controls.Base.cEntityDataPresenterCtl--%>
<table width='100%' cellpadding='5' cellspacing='0'>
	...
	<tr class='MinorSeparatorHdg'>
		...
		<td width='18%'>
			Total Interim Case Services</td>
		<td width='18%'>
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
					<Control ID='ctlClientServicesList' 
						...
						DataPresenterID='DPL' 
						DataPresenterURL='Implementation/Modules/GAR/ProjectedCaseServ/Controls/PageSection/ProjectedCaseServicesItem.ascx'/>
				</DisplayProperty>
			</DisplayProperties>
		</DataObject>
