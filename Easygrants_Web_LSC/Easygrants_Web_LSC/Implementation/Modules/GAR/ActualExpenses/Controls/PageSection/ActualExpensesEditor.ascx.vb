...
Namespace Implementation.Modules.GAR.ActualExpenses.Controls.PageSection
Public Class cActualExpensesEditor
...
Public Overrides Sub BuildHeaderRow()
	...
	aTD1.InnerHtml = "<b>Expense Category</b>"
	aTD1.Width = "35%"
	aTD1.BgColor = "DDDDDD"
	...
	aTD2.Width = "25%"
	aTD2.BgColor = "DDDDDD"
	mAmountColumn = 2	'Total and subtotal amounts are displayed in the second cell of the row.

	aTD3.InnerHtml = "<b>Non-LSC Expenditures</b>"
	aTD3.Align = "Right"
	aTD3.Width = "25%"
	aTD3.BgColor = "DDDDDD"
...
Public Overrides Sub BuildSubtotalRow(ByVal aBudgetCategory As cDataObject, ByVal aIndent As Integer, _
	...
	If aBudgetCategory.GetPropertyInt("BudgetCategoryID") <> mTopBudgetCategoryID Then
		aTD.InnerHtml = "<b>" + _
				...
				"</b>"
	Else
		aTD.InnerHtml = "<b>Total All Expenses</b>"
	End If
	aTD.ColSpan = 1
	Dim aID As String
	...
	aTD.InnerHtml = "<b>" + String.Format("{0:$#,0}", aLscExpense) + "</b>"
	aTD.Align = "right"

	'Total Non-LSC
	aTD = Add_CellsToColumn(aTR, mAmountColumn + 1)
	aTD.InnerHtml = "<b>" + String.Format("{0:$#,0}", aNonLscExpense) + "</b>"
	aTD.Align = "right"
...
Public Overrides Sub BuildDataCollectionRow(ByVal aBudgetCategory As cDataObject, ByVal aIndent As Integer, _
	...
	If aBudgetItem Is Nothing Then
		aTD.InnerHtml = "<b>$0</b>"
	Else
		aTD.InnerHtml = "<b>" + String.Format("{0:$#,0}", aBudgetItem.GetPropertyInt("Amount", 0)) + "</b>"
	End If
	aTD.Align = "right"
...
Public Overrides Sub DataPresenter_SaveDataObjects()
	...
	'CorePage.Redirect() Commented out 1/5/09 to allow GAR expenses editors to work properly. Needs to be revisited for 2010 competition/renewal. Peter Larsen
...
Public Overrides Sub BuildParentCategoryHeaderRow(ByVal aBudgetCategory As cDataObject, ByVal aIndent As Integer)
	 Dim aTR As HtmlTableRow
	 Dim aTD As HtmlTableCell

	aTR = New HtmlTableRow()
	aTD = New HtmlTableCell
	aTD.ColSpan = mAmountColumn + 3
	aTD.InnerHtml = "<b>" + _
						aBudgetCategory.GetPropertyString("Description").Trim() + _
						"</b>"
	aTD.BgColor = "#EEEEEE"
