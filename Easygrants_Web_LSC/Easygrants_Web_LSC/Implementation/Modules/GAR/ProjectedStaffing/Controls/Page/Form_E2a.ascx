...
<table width="600"  border="0" cellspacing="0" cellpadding="0">
  <tr>
	<td><EasyGrants:cCrumbTrailDisplay id='ctlCrumbTrail' DisplayText='Set from ProgressRptHdr' visible='true'
	              AutoVDateType='Last' Key='Form_E2a' runat='server'/></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td><h1>Form E-2: Interim Recipient Staffing</h1></td>
  </tr>
  <tr>
...
<br />
<Core:cUserCtlLoader ID="CUserCtlLoader2" CtlID='ctlFormE2a' 
	Src='Implementation/Modules/GAR/ProjectedStaffing/Controls/PageSection/FormE2a_Instruct.ascx'
	runat='server' />
<br />
<Core:cUserCtlLoader ID="CUserCtlLoader1" CtlID='ctlFormE2aF' 
