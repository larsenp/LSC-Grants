...
<table width=100%>
<tr>
        <td valign="top" width='25%'><b>Previous Report Date</b></td>
        <td width='25%'><span id='spnPreviousReport' runat='server'/></td>
        <td valign="top" width='20%'><b>Next Report Date</b></td>
        <td width='25%'><span id='spnNextReport' runat='server'/></td>
</tr>
</table>
	...
	<ModuleSection>
	  ...
	  <DataObject Key='WfTaskAssignment' DataObjectDefinitionKey='WfTaskAssignment' Updatable='False'>
		   <Filters>
			...
			<Sort>
				<Argument PropertyKey='SubmittedDate' Direction='Descending' />
			</Sort>
		    <DisplayProperties>
		       <DisplayProperty PropertyKey='SubmittedDate'>
					<Control ID='spnPreviousReport'
		...
		<DataObject Key='WfTaskAssignmentid' DataObjectDefinitionKey='WfTaskAssignment' Updatable='False'>
		   <Filters>
		        <Argument Type='QueryString' TypeKey='GranteeProjectID' PropertyKey='GranteeProjectID' />
			...
			<Sort>
				<Argument PropertyKey='DueDate' Direction='Ascending' />
			</Sort>
		    <DisplayProperties>
		       <DisplayProperty PropertyKey='DueDate'>
					<Control ID='spnNextReport'
						Type='HtmlGenericControl'>
					</Control>
				</DisplayProperty>	
		     </DisplayProperties>
