			...
			<DisplayProperties>
						...
						Container='spnAdd'>
							<Action
								...
								Object='EventController'
									...
									<Parameters>
										<Argument Value='EmailTemplateEditor'/>
				...
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
					<Control ID='ctlEmailTemplateList'
						...
						MaxPerPage='10'>
						<DisplayProperty PropertyKey='Title' ColumnHeader='Template Name' Width='50%'>
							<Sortable>
								<Argument PropertyKey='Title'>
								</Argument>
							</Sortable>
						</DisplayProperty>
						<DisplayProperty PropertyKey='User.Person.LastNameFirstName' ColumnHeader='Modified By' Width='25%'>
							<Sortable>
