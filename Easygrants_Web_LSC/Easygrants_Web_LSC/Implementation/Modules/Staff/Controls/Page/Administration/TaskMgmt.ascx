...
<%@ Control Language="vb" AutoEventWireup="True" Inherits="Easygrants_Web.Implementation.Modules.Staff.Controls.Page.Administration.cTaskMgmt_LSC" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" EnableViewState="false" %>
...
<table id="Table2" border='0' cellspacing='0' cellpadding='2' runat='server'>
	...
	<tr id='trCmpt' visible='false'>
		<td><b><span id='spnCmpt' runat='server'>Funding Opportunity</span></b>
		</td>
		<td width='10'>&nbsp;</td>
		<td><Core:cUserCtlLoader CtlID='ctlCmpt' Type='cDropDown' runat='server' id="CUserCtlLoader1" /></td>
	</tr>
	<tr id='trProject' visible='false'>
		<td><b><span id='spnProject' runat='server'>Funding Cycle</span></b>
		</td>
		<td width='10'>&nbsp;</td>
