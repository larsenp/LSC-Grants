...
<br />
<div class='SeparatorHdg'>TIG Application Review - Open/Replication/Website Improvement - OPP Director</div>
<br />
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
					<Control ID='ctlReviews'
						...
						<DisplayProperty PropertyKey='StaffReviewCompleted' ColumnHeader='Staff Review Completed' Format='YesNo' >
						    <Sortable>
								<Argument PropertyKey='StaffReviewCompleted' />
							</Sortable>
						</DisplayProperty>
						<DisplayProperty PropertyKey='DataEntryCompleted' ColumnHeader='Completed' Format='YesNo' NullDisplay='No'>
						    <Sortable>
