...
<br />
<div class='SeparatorHdg'>TIG - Review Revised Payment Schedule</div>
<br />
	...
	<ModuleSection>
		<DataObject Key='LscToDoListTigAppReviewORWI' DataObjectDefinitionKey='LscToDoListTigAppReviewORWI' Updatable='False' CreateNew='False'>
			<Filters>
				...
				<Argument PropertyKey='WfTaskID' Value='59' />
			</Filters>
			<Sort>
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
					<Control ID='ctlReviews'
						...
						SeparatorWidth='2'
						MaxPerPage='15'
						NoRecordMessage='There are no current TIG Payment Schedule Review items.'>
