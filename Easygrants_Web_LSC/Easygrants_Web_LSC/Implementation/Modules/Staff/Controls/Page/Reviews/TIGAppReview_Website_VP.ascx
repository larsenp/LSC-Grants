...
<br />
<div class='SeparatorHdg'>TIG Application Review - Website Continuation/Renewal - Vice President</div>
<br />
	...
	<ModuleSection>
		<DataObject Key='LscToDoListTigAppReviewORWI' DataObjectDefinitionKey='LscToDoListTigAppReviewORWI' Updatable='False' CreateNew='False'>
			<Filters>
				...
				<Argument PropertyKey='WfTaskID' Value='49' />
			</Filters>
			<Sort>
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
					<Control ID='ctlReviews'
						...
						SeparatorWidth='2'
						MaxPerPage='15'
						NoRecordMessage='There are no current TIG Website Continuation/Renewal Application Review items.'>
