...
<br />
<div class='SeparatorHdg'>Pro Bono Innovation Fund Vice President Review</div>
<br />
...
<span id='spnConfigXML' visible='false' runat='server'>
	<ModuleSection>
		<DataObject Key='LscToDoListProBonoAppReviewDetail' DataObjectDefinitionKey='LscToDoListProBonoAppReviewDetail' Updatable='False' CreateNew='False'>
			...
			<Sort>
				<Argument PropertyKey='ApplicationScore' Direction='Descending' />
			</Sort>
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
					<Control ID='ctlReviews'
						...
						SeparatorWidth='2'
						MaxPerPage='15'
						NoRecordMessage='There are no current Pro Bono Innovation Fund Vice President Review items.'>
						...
						<DisplayProperty PropertyKey='ApplicationScore' ColumnHeader='Application Score' Format='0.0'>
							<Sortable>
								<Argument PropertyKey='ApplicationScore' />
							</Sortable>
						</DisplayProperty>
