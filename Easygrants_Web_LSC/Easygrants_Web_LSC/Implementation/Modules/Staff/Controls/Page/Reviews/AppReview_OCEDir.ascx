...
<br />
<div class='SeparatorHdg'>Application Review - OCE Director</div>
<br />
...
<table width='900'>
	<tr>
	   ...
	   <td width='145' style="text-align:Left" ><b>Funding Recommendation</b></td>
	   <td width='75' style="text-align:Left" ><b>Compliance Issues</b></td>
	   <td width='75' style="text-align:Left" ><b>Audit Issues</b></td>
...
<%--<table width='900'>
	<tr>
	   ...
	   <td width='75' style="text-align:Left" ><b>Compliance Audit Issues</b></td>
	   <td width='50' style="text-align:Left" ><b>SGC</b></td>
	</tr>
</table>
<table width='900'>
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
				   <Control ID='ctlDPL' 
						...
						DataPresenterID='DPL' 
						DataPresenterURL='Implementation/Modules/Staff/Controls/Page/Reviews/AppReview_OCEDir_Child.ascx' />
				</DisplayProperty>
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
				   <Control ID='ctlDPLReviewsCompleted' 
						...
						Type='cDataPresenterList' 
						DataPresenterID='DPL' 
						DataPresenterURL='Implementation/Modules/Staff/Controls/Page/Reviews/AppReview_OCEDir_Child_ReadOnly.ascx' />
				</DisplayProperty>
			</DisplayProperties>
		</DataObject>--%>
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
					<Control ID='ctlDPLReviewsCompleted'
						...
						SeparatorWidth='2'
						MaxPerPage='15'
						NoRecordMessage='There are no current OCE Director Application Review items.'>
					    ...
					    <DisplayProperty PropertyKey='WfTaskAssignment.LscReviewApplication.ComplianceIssues' ColumnHeader='Compliance Issues' Format='YesNo' />
					    <DisplayProperty PropertyKey='WfTaskAssignment.LscReviewApplication.AuditIssues' ColumnHeader='Audit Issues' Format='YesNo' />
					    <DisplayProperty PropertyKey='WfTaskAssignment.LscReviewApplication.SpecialGrant' ColumnHeader='SGC' Format='YesNo' />
					    <DisplayProperty PropertyKey='WfTaskAssignment.LscOA1.StaffReaderPerson.FirstNameLastName' ColumnHeader='OCE Director' />
