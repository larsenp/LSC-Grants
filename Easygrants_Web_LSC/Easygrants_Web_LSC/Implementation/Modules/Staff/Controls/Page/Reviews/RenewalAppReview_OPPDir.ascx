...
<br />
<div class='SeparatorHdg'>Renewal Application Review - OPP Director</div>
<br />
...
<table width='900'>
	<tr>
	   ...
	   <td width='75' style="text-align:Left" ><b>Funding Recommendation</b></td>
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
				   <Control ID='ctlDPL' 
						...
						DataPresenterID='DPL' 
						DataPresenterURL='Implementation/Modules/Staff/Controls/Page/Reviews/RenewalAppReview_OPPDir_Child.ascx' />
				</DisplayProperty>
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
				   <Control ID='ctlDPLReviewsCompleted' 
						...
						Type='cDataPresenterList' 
						DataPresenterID='DPL' 
						DataPresenterURL='Implementation/Modules/Staff/Controls/Page/Reviews/RenewalAppReview_OPPDir_Child_ReadOnly.ascx' />
				</DisplayProperty>
			</DisplayProperties>
		</DataObject>--%>
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
					<Control ID='ctlDPLReviewsCompleted'
						...
						SeparatorWidth='2'
						MaxPerPage='15'
						NoRecordMessage='There are no current OPP Director Renewal Application Review items.'>
						...
						<DisplayProperty PropertyKey='WfTaskAssignment.LscRenewalRec.PrimaryReaderPerson.FirstNameLastName' ColumnHeader='OPP Director' />
