...
<br />
<div class='SeparatorHdg'>Renewal Application Review - OCE Director</div>
<br />
...
<table width='950'>
	<tr>
	   ...
	   <td width='100' style="text-align:Left" ><b>Service Area</b></td>
	   <td width='200' style="text-align:Left" ><b>Task</b></td>
	   <td width='200' style="text-align:Left" ><b>Funding Recommendation</b></td>
	   <td width='50' style="text-align:Left" ><b>Compliance Issues</b></td>
	   <td width='50' style="text-align:Left" ><b>Audit Issues</b></td>
...
<%--<table width='900'>
	<tr>
	   <td width='50' style="text-align:Left" ><b>Recipient ID</b></td>
	   <td width='200' style="text-align:Center" ><b>Organization</b></td>
	   <td width='100' style="text-align:Center" ><b>Service Area</b></td>
	   <td width='200' style="text-align:Center" ><b>Task</b></td>
	   <td width='200' style="text-align:Center" ><b>Funding Recommendation</b></td>
	   <td width='75' style="text-align:Center" ><b>Compliance Audit Issues</b></td>
	   <td width='75' style="text-align:Center" ><b>SGC</b></td>
	</tr>
</table>
<table width='900'>
	<tr><td class='MinorSeparatorHdg'>&nbsp;</td></tr>
...
<span id='spnConfigXML' visible='false' runat='server'>
	<ModuleSection>
	   ...
	   <DataObject Key='LscToDoListRenewalAppReview' DataObjectDefinitionKey='LscToDoListRenewalAppReview' Updatable='True' CreateNew='True'>
			...
			<Sort>
				<Argument PropertyKey="RecipientID" Direction='Ascending'/>
			</Sort>
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
				   <Control ID='ctlDPL' 
						...
						DataPresenterID='DPL' 
						DataPresenterURL='Implementation/Modules/Staff/Controls/Page/Reviews/RenewalAppReview_OCEDir_Child.ascx' />
				</DisplayProperty>
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
				   <Control ID='ctlDPLReviewsCompleted' 
						...
						Type='cDataPresenterList' 
						DataPresenterID='DPL' 
						DataPresenterURL='Implementation/Modules/Staff/Controls/Page/Reviews/RenewalAppReview_OCEDir_Child_ReadOnly.ascx' />
				</DisplayProperty>
			</DisplayProperties>
		</DataObject>
   --%>
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
					<Control ID='ctlDPLReviewsCompleted'
						...
						SeparatorWidth='2'
						MaxPerPage='15'
						NoRecordMessage='There are no current OCE Director Renewal Application Review items.'>
						...
						<DisplayProperty PropertyKey='WfTaskAssignment.LscRenewalRec.ComplianceIssues' ColumnHeader='Compliance Issues' Format='YesNo' />
						<DisplayProperty PropertyKey='WfTaskAssignment.LscRenewalRec.AuditIssues' ColumnHeader='Audit Issues' Format='YesNo' />
						<DisplayProperty PropertyKey='WfTaskAssignment.LscRenewalRec.YesNoSpecialGrantCond' ColumnHeader='SGC' Format='YesNo' />
						<DisplayProperty PropertyKey='WfTaskAssignment.LscRenewalRec.PrimaryReaderPerson.FirstNameLastName' ColumnHeader='OCE Director' />
