...
<Core:cUserCtlLoader CtlID='ctlSubgrantInfo' 
	Src='Implementation/Modules/SubgrantApprovalReview_OPPStaff/PageSection/SubgrantRequestInformation.ascx'
	runat='server'/>
...
<p>
	...
	section, labeled "OPP Staff Review Findings", and a second section which varies depending on which
	selection has been made on the Recommendation question. In some cases, if you change data in both the "OPP
	Staff Review Findings" and the recommendation-specific section below, then click <b>Save</b> or <b>Save and 
...
<table cellpadding="1" width="600px" >
	...
	<tr>
		<td valign="top">
			<b>Recommendation<%=kDenoteRequiredField %></b>
		</td>
		<td>
...
<Core:cUserCtlLoader CtlID='ctlFullApproval' 
	Src='Implementation/Modules/SubgrantApprovalReview_OPPStaff/PageSection/FullApproval.ascx'
	runat='server'/>

<Core:cUserCtlLoader CtlID='ctlPartialApproval' 
	Src='Implementation/Modules/SubgrantApprovalReview_OPPStaff/PageSection/PartialApproval.ascx'
	runat='server'/>
	
<Core:cUserCtlLoader CtlID='ctlProvisionalApproval' 
	Src='Implementation/Modules/SubgrantApprovalReview_OPPStaff/PageSection/ProvisionalApproval.ascx'
	runat='server'/>

<Core:cUserCtlLoader CtlID='ctlDenial'
	Src='Implementation/Modules/SubgrantApprovalReview_OPPStaff/PageSection/Denial.ascx'
	runat='server'/>
<br />
