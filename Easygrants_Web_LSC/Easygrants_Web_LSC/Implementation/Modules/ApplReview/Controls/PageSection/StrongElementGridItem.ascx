...
<span id='spnConfigXML' visible='false' runat='server'>
	<ModuleSection>
		<DataObject DataObjectSource='DataPresenterList' DataObjectSourceKey='StrongElements' Key='StrongElements' DataObjectDefinitionKey='LscReviewInquiryElement' Updatable='False' CreateNew='False'>
			<DisplayProperties>
		...
		<DataObject Key='StrongElement' DataObjectDefinitionKey='LscReviewAssignmentElement' Updatable='True' CreateNew='True' >
			<Filters>
				<Argument Type='DataPresenter' TypeKey='WfTaskAssignmentID' PropertyKey='WfTaskAssignmentID' />
				<Argument Type='DataObjectCollection' TypeKey='StrongElements' DataObjectPropertyKey='LscReviewElementID' PropertyKey='LscReviewElementID' />
			</Filters>
			<DefaultValues>
				<Argument Type='DataPresenter' TypeKey='WfTaskAssignmentID' PropertyKey='WfTaskAssignmentID' Create='True' Update='False'/>
				<Argument Type='DataObjectCollection' TypeKey='StrongElements' DataObjectPropertyKey='LscReviewElementID' PropertyKey='LscReviewElementID' Create='True' Update='False' />
			</DefaultValues>
			<DisplayProperties>
