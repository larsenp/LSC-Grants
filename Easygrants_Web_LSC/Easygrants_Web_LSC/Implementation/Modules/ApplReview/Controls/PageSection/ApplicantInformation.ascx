...
<span id='spnConfigXML' visible='false' runat='server'>
	<ModuleSection>
		...
		<DataObject Key='ReviewTotalScore' DataObjectDefinitionKey='ReviewTotalScore' Updatable='False' CreateNew='False'>
			<Filters>
				<Argument Type='DataPresenter' TypeKey='WfTaskAssignmentID' PropertyKey='ReviewWfTAID' />
			</Filters>
			<DisplayProperties>
