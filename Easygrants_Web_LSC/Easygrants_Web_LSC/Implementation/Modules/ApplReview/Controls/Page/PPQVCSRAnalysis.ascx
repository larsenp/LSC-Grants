...
<table width='600px' cellpadding='1'>
	...
	<tr>
		<td>
			<b>Percentage of non-LSC funding</b><sup>(1)</sup></td>
		<td style="text-align:center">
...
<p><i>
Ref: (1) This calculation excludes LSC funding carryover, Non-LSC funding carryover, and Client Service Income revenue.</p> </i>
<br />
<div class='SeparatorHdg' width='100%'>
	Reviewer's Summary
</div>
<p>2. Are total CSR numbers below 70% of the national median &mdash; less than <span runat='server' id='spnMedianCasesPer10k_70_2' /> per 
10,000 poverty population?</p>
<b><span runat='server' id='spnCSRBelow70' /></b>

<a name='q2' ></a>
<p>3. <i>Only for applications for which total CSR numbers are below 70% of the national median.</i><br />
Analysis when total cases per 10,000 poverty population are below 70% of the median.  (See <a href='#q2i'>detailed instructions</a>)   </p>
...
<br /><br />
<p>4. Are PAI CSR numbers below 70% of the national median — less than <span runat='server' id='spnMedianPAICasesPer10k_70_2' /> per 10,000 poverty population?</p> <b><span runat='server' id='spnPAICSRBelow70' /></b>

<p>5. <i>Only for applications for which PAI CSR numbers are below 70% of the national median.</i><br />
...
<a name='q3' ></a><p>6.  Are there other CSR number patterns to be looked into? (See <a href='#q3i' >detailed instructions</a>)</p>
<table style="padding:1px">
	...
	<tr>
		...
		<td>
			Other pattern?  Describe.<span style="color:red">*</span> 
		</td>
	</tr>
</table>
...
<a name='q4'></a><p>7.  <b>Conclusion</b>. CSRs as indicated above:<span style="color:red">*</span> </p>
<span runat='server' id='spnCsrAnalysisConclusionID'/><br />
8. Briefly explain conclusions. For those programs outside the 70% of median or average provide a summary assessment of the applicant’s CSRs. <span style="color:red">*</span><br />
