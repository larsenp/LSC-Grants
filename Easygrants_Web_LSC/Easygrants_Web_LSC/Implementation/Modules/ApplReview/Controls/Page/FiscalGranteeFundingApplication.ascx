...
<h1>Fiscal Grantee Funding Application</h1>
<br />
...
<table style='width:800px;'>
	...
	<tr>
		<td>1.</td>
		<td>Has your Board of Directors (BOD), established the following committees?</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td>a. Finance Committee? </td>
...
<p><b>OCE Staff Reviewer</b>: <span runat='server' id='spnOCEStaffReviewer'/></p>
<p><b>OCE Staff Review Status</b>: <span runat='server' id='spnOCEStaffReviewStatus'/></p>
			...
			<DisplayProperties>				
				<DisplayProperty PropertyKey=''>
					<Control ID='ctlApplicantReportLink'
						...
						DisplayText='~View OCE Staff Review PDF~'>
						<Visible>
							<Argument Type='DataObjectCollection' TypeKey='ReportOutputLink' DataObjectPropertyKey='WfTaskStatusID' Value='2'/>
						</Visible>
						<Parameters>
				...
				<DisplayProperty PropertyKey='Person.FirstNameLastName'>
					<Control ID='spnOCEStaffReviewer'
						Type='HtmlGenericControl'/>
				</DisplayProperty>
				<DisplayProperty PropertyKey='WfTaskStatus.WfTaskStatus'>
					<Control ID='spnOCEStaffReviewStatus'
						Type='HtmlGenericControl'/>
				</DisplayProperty>
			</DisplayProperties>
		</DataObject>
