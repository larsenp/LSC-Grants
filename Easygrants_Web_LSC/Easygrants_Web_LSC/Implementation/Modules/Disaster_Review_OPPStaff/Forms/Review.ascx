...
<table width='600' border="0" cellpadding='0' cellspacing='0'>
  ...
  <tr>
  	...
  	<td>
        ...
        <ol>
          <li>Under the <strong>Type</strong> control located in the <strong>Upload</strong> section at the bottom of the screen,  select <strong>Disaster Grant Review</strong> from the drop-down menu.  </li>
