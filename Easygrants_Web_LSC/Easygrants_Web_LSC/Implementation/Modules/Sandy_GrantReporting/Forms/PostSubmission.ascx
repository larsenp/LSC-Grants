...
<div style="width:600px">
	...
	<br />
    <br />
	<span runat='server' id='spnViewTechNY'/><span runat='server' id='spnViewTechNJ'/><span runat='server' id='spnViewTechOM'/>
	<br />
    <br />
	...
	<ModuleSection>
       <DataObject Key='SubmittedFileWord' DataObjectDefinitionKey='SubmittedFile' Updatable='False' CreateNew='False' >
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey=''>
					<Control ID='btnViewWord'
						...
						Image='View Sandy Narrative Report'>
		 ...
		 <DataObject Key='SubmittedFileTechNY' DataObjectDefinitionKey='SubmittedFile' Updatable='False' CreateNew='False' >
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey=''>
					<Control ID='btnViewTechNY'
						Type='cButton'
						Container='spnViewTechNY'
						Image='View LSNYC Sandy Technology Report'>
						<Action PostBack='True'
							Object='DataPresenter'
							Method='DocumentList_ViewConvertedUploadedFile'>
							<Parameters>
								<Argument Type='DataObjectCollection' TypeKey='SubmittedFileTechNY' DataObjectPropertyKey='SubmittedFileID'/>
							</Parameters>	
						</Action>	
						<Visible>
		 ...
		 <DataObject Key='SubmittedFileTechNJ' DataObjectDefinitionKey='SubmittedFile' Updatable='False' CreateNew='False' >
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey=''>
					<Control ID='btnViewTechNJ'
						Type='cButton'
						Container='spnViewTechNJ'
						Image='View NNJLS Sandy Technology Report'>
						<Action PostBack='True'
							Object='DataPresenter'
							Method='DocumentList_ViewConvertedUploadedFile'>
							<Parameters>
								<Argument Type='DataObjectCollection' TypeKey='SubmittedFileTechNJ' DataObjectPropertyKey='SubmittedFileID'/>
							</Parameters>	
						</Action>	
						<Visible>
							<Argument PropertyKey='SubmittedFileID' Value='0' Operator='GreaterThan' NullDataObject='False' />
		 ...
		 <DataObject Key='SubmittedFileTechOM' DataObjectDefinitionKey='SubmittedFile' Updatable='False' CreateNew='False' >
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey=''>
					<Control ID='btnViewTechOM'
						Type='cButton'
						Container='spnViewTechOM'
						Image='View OMLS Sandy Technology Report'>
						<Action PostBack='True'
							Object='DataPresenter'
							Method='DocumentList_ViewConvertedUploadedFile'>
							<Parameters>
								<Argument Type='DataObjectCollection' TypeKey='SubmittedFileTechOM' DataObjectPropertyKey='SubmittedFileID'/>
							</Parameters>	
						</Action>	
						<Visible>
							<Argument PropertyKey='SubmittedFileID' Value='0' Operator='GreaterThan' NullDataObject='False' />
