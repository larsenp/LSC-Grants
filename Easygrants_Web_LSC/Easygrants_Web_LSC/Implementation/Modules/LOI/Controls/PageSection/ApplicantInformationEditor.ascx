...
<table  border='0' cellspacing='0' cellpadding='0' runat='server' width='600'>
	<tr>
	  <td><h1>Applicant Information Editor </h1></td>
  </tr>
	<tr>
	  <td><table id="Table_Instructions" border='0' cellspacing='0' cellpadding='0' runat='server' width='600'>
        ...
        <tr>
          <td valign="top" ><ul>
            ...
            <p>Within <strong>Applicant Category</strong>, the definition of Private Attorney(s), Groups of Attorneys or Law Firms is as follows:</p>
            <ul>
...
<table border='0' cellspacing='0' cellpadding='0' runat='server' width='100%'>
	<tr>
		<td colspan="4" class="SeparatorHdg">Add or Edit Applicant Information</td>
	</tr>	
	<tr><td>&nbsp;</td>
	</tr>
</table>
...
<table border='0' cellspacing='0' cellpadding='0' runat='server' width='100%'>
	<tr>
		...
		<td colspan='3'><span id='spnOrg' runat='server'/></td>
	</tr>
...
<span id='spnConfigXML' visible='false' runat='server'>
	...
	<tr>
	<td>&nbsp;</td>
	<td>Click  Select  to choose your Organization</td>
	</tr>
    -->
