...
<table border='0' cellspacing='0' cellpadding='0' runat='server' width='100%'>
	<tr>
		<td colspan="2" class="SeparatorHdg"><b>How did you find out about the LSC Grants Competition?</b></td>
	</tr>	
	<tr><td>&nbsp;</td></tr>
	<tr>
		<td>
			<b>How did you find out about the LSC Grants competition?</b><%=kDenoteRequiredField%>
		</td>
		<td>
			<span runat='server' id='spnLscCompInfoSourceID'/>
		</td>
	</tr>
	<tr>
		<td>
		...
		<td><span runat='server' id='spnLscCompInfoSourceOther'/></td>
	</tr>
	<tr><td>&nbsp;</td></tr>
	<tr>
...
<span id='spnConfigXML' visible='false' runat='server'>
	<ModuleSection>
		...
		<DataObject Key='LscGranteeProjectInfo' DataObjectDefinitionKey='LscGranteeProjectInfo' Updatable='True' CreateNew='True'>
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='LscCompInfoSourceID'>
					<Control ID='ctlLscCompInfoSourceID'
						Type='cDropDown'
						Container='spnLscCompInfoSourceID'
						DataObjectDefinitionKey='LscCompInfoSource'
						StoredValue='LscCompInfoSourceID'
						DisplayValue='Description'/>
				</DisplayProperty>
				<DisplayProperty PropertyKey='LscCompInfoSourceOther'>
					<Control ID='txtLscCompInfoSourceOther'
						Type='cTextBox'
						Container='spnLscCompInfoSourceOther'
						Size='30'/>
				</DisplayProperty>
				<DisplayProperty PropertyKey=''>
					<Control ID='btnSave'
