...
<table id="Table1" border='0' cellspacing='0' cellpadding='2' runat='server' width='100%'>
	...
	<tr><td>&nbsp;</td></tr>
	<tr><td width='15%'><b><%=GetLabel("LegacyGrantId")%></b></td><td><span id='spnLegacyGrantID' runat='server'></span></td></tr>
	<tr><td><b>Recipient ID</b></td><td><span id='spnRecipientID' runat='server'></span></td></tr>
