CREATE VIEW vLSC_PROJECTED_STAFF_TOTALS
...
SELECT [lsc_projected_staff_id]
	...
	,ISNULL([dir_ft], 0) + ISNULL([dep_Dir_ft], 0) + ISNULL([dir_Ltg_ft], 0) + ISNULL([mng_Atrny_ft], 0) + ISNULL([supr_Atrny_ft], 0) + ISNULL([stf_Atrny_ft], 0) + ISNULL([prlgl_ft], 0) + ISNULL([pai_Cord_ft], 0) + ISNULL([trng_Cord_ft], 0) + ISNULL([fin_Prof_ft], 0) + ISNULL([mng_Prof_ft], 0) + ISNULL([law_Clerk_ft], 0) + ISNULL([sr_Aide_ft], 0) + ISNULL([admn_Asst_ft], 0) + ISNULL([sec_Or_Cl_ft], 0) + ISNULL([other_ft], 0) + ISNULL([it_ft], 0) ft_total
	,ISNULL([dir_pt], 0) + ISNULL([dep_Dir_pt], 0) + ISNULL([dir_Ltg_pt], 0) + ISNULL([mng_Atrny_pt], 0) + ISNULL([supr_Atrny_pt], 0) + ISNULL([stf_Atrny_pt], 0) + ISNULL([prlgl_pt], 0) + ISNULL([pai_Cord_pt], 0) + ISNULL([trng_Cord_pt], 0) + ISNULL([fin_Prof_pt], 0) + ISNULL([mng_Prof_pt], 0) + ISNULL([law_Clerk_pt], 0) + ISNULL([sr_Aide_pt], 0) + ISNULL([admn_Asst_pt], 0) + ISNULL([sec_Or_Cl_pt], 0) + ISNULL([other_pt], 0) + ISNULL([it_pt], 0) pt_total
	,ISNULL([dir_vlnt], 0) + ISNULL([dep_Dir_vlnt], 0) + ISNULL([dir_Ltg_vlnt], 0) + ISNULL([mng_Atrny_vlnt], 0) + ISNULL([supr_Atrny_vlnt], 0) + ISNULL([stf_Atrny_vlnt], 0) + ISNULL([prlgl_vlnt], 0) + ISNULL([pai_Cord_vlnt], 0) + ISNULL([trng_Cord_vlnt], 0) + ISNULL([fin_Prof_vlnt], 0) + ISNULL([mng_Prof_vlnt], 0) + ISNULL([law_Clerk_vlnt], 0) + ISNULL([sr_Aide_vlnt], 0) + ISNULL([admn_Asst_vlnt], 0) + ISNULL([sec_Or_Cl_vlnt], 0) + ISNULL([other_vlnt], 0) + ISNULL([it_vInt], 0) vlnt_total  
