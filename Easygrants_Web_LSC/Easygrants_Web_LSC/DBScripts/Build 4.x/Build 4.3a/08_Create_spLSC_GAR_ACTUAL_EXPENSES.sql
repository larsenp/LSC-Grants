/****** Object:  StoredProcedure [dbo].[spLSC_GAR_ACTUAL_EXPENSES]    Script Date: 02/13/2009 10:30:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[spLSC_GAR_ACTUAL_EXPENSES]
...
select bcp.description expense_category,
	bc.description expense_type,
	SUM(lbi.lsc_expenditures) lsc_expenditures,
	SUM(lbi.non_lsc_expenditures) non_lsc_expenditures,
	SUM(bi.amount) total
	...
	where wfta.wf_task_id = 8
		and bc.category_type_id = 8
	...
	GROUP BY bcp.description,
		...
		bc.description,
		bc.sort_order
	order by bcp.sort_order,
		bc.sort_order


GRANT EXECUTE ON [dbo].[spLSC_GAR_ACTUAL_EXPENSES] TO [LSC.GOV\OIM WebDev]