/****** Object:  View [dbo].[vLSC_ACTUAL_EXPENSES_NON_LSC_PIVOT]    Script Date: 02/13/2009 10:25:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE VIEW [dbo].[vLSC_ACTUAL_EXPENSES_NON_LSC_PIVOT]
...
from
	(select wfta.wf_task_assignment_id,
		...
		where wfta.wf_task_id = 8
			and bc.category_type_id = 8) as expense
	pivot
