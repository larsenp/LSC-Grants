/****** Object:  View [dbo].[vLSC_CSR]    Script Date: 02/03/2009 17:31:49 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE VIEW [dbo].[vLSC_CSR]
AS
SELECT o.organization_id,
	...
	FROM LSC_CSR csr
		...
		JOIN LSC_c_ATTORNEY_PAI_STATUS aps ON csr.lsc_attorney_pai_status_id = aps.id