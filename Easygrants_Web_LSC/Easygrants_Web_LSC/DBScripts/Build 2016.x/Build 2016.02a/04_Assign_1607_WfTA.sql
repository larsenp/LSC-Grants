...
set @year = 2016
set @start_date = '2016-1-29'
set @open_date = '2016-1-29'
set @due_date = '2016-2-19'
set @close_date = '2016-2-26'
set @end_date = '2016-2-26'
...
insert #wfta(wfta_key)
    select min(cast(sa.service_area_type_id as varchar(1)) + '_' + c.description + '_' + cast(gp.grantee_project_id as varchar(4)))
        from vLSC_BOARD_COMPLIANCE bc
			...
			JOIN vLSC_COMP_WFTA_ORG_SERVAREA_YEAR cwosy ON gp.grantee_project_id = cwosy.grantee_project_id
