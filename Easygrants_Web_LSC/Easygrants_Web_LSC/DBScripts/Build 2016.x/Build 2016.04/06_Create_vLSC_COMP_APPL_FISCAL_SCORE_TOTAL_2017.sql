CREATE VIEW [dbo].[vLSC_COMP_APPL_FISCAL_SCORE_TOTAL_2017]
...
SELECT	wfta.wf_task_assignment_id
	...
	FROM WF_TASK_ASSIGNMENT wfta
		...
		JOIN vLSC_COMP_APPL_FISCAL_SCORE_BY_PART_2017 cafsp ON caf.lsc_comp_appl_fiscal_id = cafsp.lsc_comp_appl_fiscal_id
