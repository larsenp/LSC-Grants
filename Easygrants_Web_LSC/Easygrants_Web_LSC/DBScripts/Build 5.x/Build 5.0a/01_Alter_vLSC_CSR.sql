/****** Object:  View [dbo].[vLSC_CSR]    Script Date: 04/09/2009 09:54:02 ******/

--Add Total field to view
SET ANSI_NULLS ON
GO
...
SELECT o.organization_id,
	...
	ISNULL(csr.K, 0) K,
	ISNULL(csr.L, 0) L,
	ISNULL(A, 0) + ISNULL(B, 0) + ISNULL(F, 0) + ISNULL(G, 0) + ISNULL(H, 0) + ISNULL(Ia, 0) + ISNULL(Ib, 0) + ISNULL(Ic, 0) + ISNULL(K, 0) + ISNULL(L, 0) Total
	FROM LSC_CSR csr
