/****** Object:  View [dbo].[vLSC_OPEN_CASE]    Script Date: 04/22/2009 14:27:58 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER VIEW [dbo].[vLSC_OPEN_CASE]
...
SELECT wfta.wf_task_assignment_id,
	...
	CASE WHEN wfta.wf_task_id = 14 THEN 4 ELSE rsat.ID END ServiceAreaTypeID,
	oc.con_fin,
	oc.education,
	oc.employment,
	oc.family,
