/****** Object:  StoredProcedure [dbo].[spLSC_COPY_APP_BUDGET_INFO]    Script Date: 04/22/2009 16:12:01 ******/
SET ANSI_NULLS ON
GO
...
IF @prev_task_id <> @task_id or @prev_grantee_project_id <> @grantee_project_id
BEGIN
