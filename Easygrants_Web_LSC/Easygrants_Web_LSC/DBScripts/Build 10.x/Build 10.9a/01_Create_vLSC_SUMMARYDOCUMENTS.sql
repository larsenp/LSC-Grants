--Allow for proper handling of per-grantee-project documents in Summary Documents list in grant file
--Mantis 3033

CREATE VIEW [dbo].[vLSC_SUMMARYDOCUMENTS]

AS

SELECT     wfta.wf_task_assignment_id + rd.report_output_definition_id AS summary_document_id, 
...
SELECT     gp.grantee_project_id + rd.report_output_definition_id AS summary_document_id, 
