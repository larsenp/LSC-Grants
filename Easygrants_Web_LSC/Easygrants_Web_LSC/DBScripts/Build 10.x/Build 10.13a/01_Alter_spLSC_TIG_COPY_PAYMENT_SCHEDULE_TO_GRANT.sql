/****** Object:  StoredProcedure [dbo].[spLSC_TIG_COPY_PAYMENT_SCHEDULE_TO_GRANT]    Script Date: 09/29/2011 09:54:45 ******/
SET ANSI_NULLS ON
GO
...
UPDATE p_after
	...
	FROM #pps p_after
		JOIN #pps p_before on p_after.payment_number = p_before.payment_number + 1
