/*
Methodology for creating new IDs for LSC_TIG_BUDGET_ITEM rows (line 58) is faulty.
Added call to spUPDATE_IDGEN at the end of the stored procedure as a temporary fix.
Peter Larsen 10/31/2011
*/

USE [Easygrants]
GO
/****** Object:  StoredProcedure [dbo].[spLSC_XFER_TIG_BUDGET_TO_GP]    Script Date: 10/31/2011 10:50:43 ******/
SET ANSI_NULLS ON
GO
