--Add President review of TIG LOIs (wf_task_id = 71)

/****** Object:  View [dbo].[vLSC_TO_DO_LIST_TIG_APP_REVIEW_O_R_WI]    Script Date: 03/30/2011 13:41:44 ******/
SET ANSI_NULLS ON
GO
...
SELECT 	wfta.wf_task_assignment_id,
	...
	WHERE wfta.wf_task_id in (39, 43, 45, 46, 48, 49, 50, 51, 58, 59, 62, 70, 71)
