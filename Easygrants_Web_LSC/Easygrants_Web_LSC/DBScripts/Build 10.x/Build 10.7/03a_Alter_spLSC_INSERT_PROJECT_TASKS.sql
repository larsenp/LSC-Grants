--Add report keys for staff reviews of post-PQV applications

/****** Object:  StoredProcedure [dbo].[spLSC_INSERT_PROJECT_TASKS]    Script Date: 07/01/2011 10:56:00 ******/
SET ANSI_NULLS ON
GO
...
IF @wf_task_id IN (1,2,4,66,67,72)
BEGIN
	CREATE TABLE #pdf(
