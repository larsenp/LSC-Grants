--Hide service area designation for Upload Certification task (wf_task_id = 7)
--Mantis 2362

/****** Object:  View [dbo].[vTO_DO_LIST_APPLICATION]    Script Date: 07/27/2011 09:28:07 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER VIEW [dbo].[vTO_DO_LIST_APPLICATION]
...
SELECT 	wfta.wf_task_assignment_id,
	...
	CASE WHEN wfta.wf_task_id = 7 THEN '' ELSE c.description END service_area,
	wcy.wfta_year,
	wftm.module_name,
