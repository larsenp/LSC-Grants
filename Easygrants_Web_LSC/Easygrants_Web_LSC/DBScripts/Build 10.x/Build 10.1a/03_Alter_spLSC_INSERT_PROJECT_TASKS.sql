--Add functionality for post-PQV application tasks
--Add identity column to main temp table only after all deletions have been made. This ensures a contiguous allocation of IDs and keeps actual IDs consistent with next_id value in s_ID_GEN.
/****** Object:  StoredProcedure [dbo].[spLSC_INSERT_PROJECT_TASKS]    Script Date: 02/02/2011 11:17:51 ******/
SET ANSI_NULLS ON
GO
