--Allow subgrantee name to be displayed for Request Subgrant Modification task assignments

/****** Object:  View [dbo].[vLSC_APPS_EASYLIST]    Script Date: 08/11/2011 09:54:16 ******/
SET ANSI_NULLS ON
GO
...
SELECT wfta.wf_task_assignment_id ,
    ...
    FROM WF_TASK_ASSIGNMENT wfta
		...
		LEFT JOIN WF_TASK_ASSIGNMENT wfta_sar ON gp.grantee_project_id = wfta_sar.grantee_project_id --subgrant approval request
			AND wfta_sar.wf_task_id = 53
		LEFT JOIN LSC_WFTA_SUBGRANT ws ON wfta_sar.wf_task_assignment_id = ws.wf_task_assignment_id
