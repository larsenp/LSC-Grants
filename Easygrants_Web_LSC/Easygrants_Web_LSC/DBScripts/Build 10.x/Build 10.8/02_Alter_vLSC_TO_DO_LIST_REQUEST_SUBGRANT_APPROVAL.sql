/****** Object:  View [dbo].[vLSC_TO_DO_LIST_REQUEST_SUBGRANT_APPROVAL]    Script Date: 07/12/2011 14:10:32 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER VIEW [dbo].[vLSC_TO_DO_LIST_REQUEST_SUBGRANT_APPROVAL]
...
SELECT 	wfta.wf_task_assignment_id,
	...
	CASE WHEN wfta.wf_task_status_id = 2 THEN wfta_mod.wf_task_assignment_id ELSE NULL END open_mod_wfta_id
	FROM WF_TASK_ASSIGNMENT wfta
		...
		LEFT JOIN WF_TASK_ASSIGNMENT wfta_mod ON wfta.grantee_project_id = wfta_mod.grantee_project_id
