...
ALTER PROCEDURE [dbo].[spLSC_INSERT_PROJECT_TASK_COMPREVIEW_MW_NA_PDF]
(@time_period_id int)
...
INSERT #pdf
		...
		SELECT 
			...
			2,
			'CompAppStaffReview',
			'Competition Staff Review without CSR',
			0
        ...
        Where wft.id = 5 and
            awfp.time_period_id = @time_period_id and csa.id in (2,3) --MW, NA
