--Exclude very recent PQVs from post-PQV apps. Mantis 2887.
...
SELECT organization_id,
	...
	CASE WHEN dbo.fnLSC_MOST_RECENT_PQV_DATE(organization_id) IS NULL THEN 0
		...
		WHEN dbo.fnLSC_MOST_RECENT_PQV_DATE(organization_id) > CAST(CAST(YEAR(GETDATE()) AS VARCHAR(4)) + '-03-18' AS DATETIME) THEN 0
