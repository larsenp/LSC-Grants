...
ALTER PROCEDURE [dbo].[spLSC_POSTSUBMISSION_TIG_REVIEW_PAYMENT_SCHEDULE_REVISION]
...
SELECT @gap_wfta_id = wfta_gap.wf_task_assignment_id
	FROM WF_TASK_ASSIGNMENT wfta_payment
		JOIN WF_TASK_ASSIGNMENT wfta_gap on wfta_gap.grantee_project_id = wfta_payment.grantee_project_id
