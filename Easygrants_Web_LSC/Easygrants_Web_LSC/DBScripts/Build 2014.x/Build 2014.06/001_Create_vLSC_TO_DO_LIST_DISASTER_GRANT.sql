IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vLSC_TO_DO_LIST_PROBONO_GRANT]'))
DROP VIEW [dbo].[vLSC_TO_DO_LIST_PROBONO_GRANT]
GO

/****** Object:  View [dbo].[vLSC_TO_DO_LIST_DISASTER_GRANT]    Script Date: 5/13/2014 10:49:53 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[vLSC_TO_DO_LIST_PROBONO_GRANT]
