/****** Object:  StoredProcedure [dbo].[spLSC_TIG_BUILD_PROPOSED_PAYMENT_SCHEDULE]    Script Date: 05/07/2014 14:31:35 ******/
SET ANSI_NULLS ON
GO
...
--Create fixed milestones for last two payments
...
--Insert two new milestones for next-to-last payment
...
INSERT INTO [LSC_MILESTONE]
     ...
     VALUES
           (@first_id
           ,1
           ,'Collect data per the Evaluation Plan.'
           ,@user_id 
           ,GETDATE()
           ,@last_payment_id - 1)
...
INSERT INTO [LSC_MILESTONE]
     ...
     VALUES
           (@first_id
           ,2
           ,'Submit final report for approval by LSC.'
           ,@user_id 
           ,GETDATE()
           ,@last_payment_id - 1)

--Insert two new milestones for last payment
EXEC @first_id = getid_sel @table='LSC_MILESTONE', @mode = 2
