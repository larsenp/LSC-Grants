CREATE VIEW [dbo].[vLSC_COMP_APPL_FISCAL_SCORE_2015]
AS
...
SELECT lsc_comp_appl_fiscal_id
	...
	,CASE WHEN has_lsc_subgrants = 1 THEN 1 ELSE 0 END has_lsc_subgrants
	...
	,CASE WHEN corrective_actions_identified = 2 THEN 5 ELSE 0 END corrective_actions_identified
	...
	,CASE WHEN lsc_fraud_insurance_policy_limit_id = 2 THEN 0.5
		WHEN lsc_fraud_insurance_policy_limit_id = 3 THEN 1 END lsc_fraud_insurance_policy_limit
