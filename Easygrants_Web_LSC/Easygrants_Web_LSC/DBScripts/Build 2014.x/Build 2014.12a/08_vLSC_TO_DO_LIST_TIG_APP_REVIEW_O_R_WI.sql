...
ALTER VIEW [dbo].[vLSC_TO_DO_LIST_TIG_APP_REVIEW_O_R_WI]
...
SELECT 	wfta.wf_task_assignment_id,
    ...
    gpt.Purpose,
    rev.data_entry_completed,
	tsrc.staff_review_completed
	FROM WF_TASK_ASSIGNMENT wfta
        ...
        JOIN LSC_GRANTEE_PROJECT_TIG gpt ON gpt.grantee_project_id = gp.grantee_project_id
        LEFT JOIN LSC_TIG_REVIEW_OPEN_REP_WEB_IMPR rev ON rev.wf_task_assignment_id = wfta.wf_task_assignment_id
		LEFT JOIN vLSC_TIG_STAFF_REVIEW_COMPLETED tsrc ON gp.grantee_project_id = tsrc.grantee_project_id
	WHERE wfta.wf_task_id in (39, 43, 45, 46, 48, 49, 50, 51, 58, 59, 62, 70, 71, 92, 122)
