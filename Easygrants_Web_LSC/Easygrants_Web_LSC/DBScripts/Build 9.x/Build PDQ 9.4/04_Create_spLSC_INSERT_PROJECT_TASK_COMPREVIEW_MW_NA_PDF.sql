...
CREATE PROCEDURE [dbo].[spLSC_INSERT_PROJECT_TASK_COMPREVIEW_MW_NA_PDF]
--Create association between project tasks and PDFs for Competition Review (MW,NA Service type) tasks
...
INSERT #pdf
        ...
        Where wft.id = 5 and
            awfp.time_period_id = 16 and csa.id in (2,3) --MW, NA
