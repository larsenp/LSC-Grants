...
CREATE PROCEDURE [dbo].[spLSC_INSERT_PROJECT_TASK_RENEWAL_REVIEW_OPPDIR_PDF]
--Create association between project tasks and PDFs for Renewal Review - OPP Dir tasks
...
INSERT #pdf
		...
		SELECT 
            wfpt.id ,
			1,
			'RenewalAppOPPDirReview',
			'Renewal App OPP Director Review',
			0
