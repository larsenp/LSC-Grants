-- Add wf_task_id 46 (VP review)
/****** Object:  View [dbo].[vLSC_TO_DO_LIST_TIG_APP_REVIEW_O_R_WI]    Script Date: 06/30/2010 10:08:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
--Add wf_task_id = 45 to filter (OPP Director Review)
...
SELECT 	wfta.wf_task_assignment_id,
	...
	WHERE wfta.wf_task_id in (43, 45, 46)
