/****** Object:  View [dbo].[vWFTA_COMPETITION_YEAR]    Script Date: 08/05/2008 17:51:45 ******/
SET ANSI_NULLS ON
GO
...
Added Upload Certification task (wf_task_id = 7) 8/5/2008.
*/

select wfta.wf_task_assignment_id, 
	case when wfta.wf_task_id = 2 then tp.sort_order
		when wfta.wf_task_id in (4,7) then tp.sort_order + wfta.award_term_id - 1 end as wfta_year
