--Add PDF associations for multiple tasks
--Mantis 3049
...
IF @wf_task_id IN (1,2,4,5,6,47,52,56,57,66,67,68,69,72,74,75)
BEGIN
	CREATE TABLE #pdf(
...
END --IF @wf_task_id IN (1,2,4,5,6,47,52,56,57,66,67,68,69,72,74,75)
