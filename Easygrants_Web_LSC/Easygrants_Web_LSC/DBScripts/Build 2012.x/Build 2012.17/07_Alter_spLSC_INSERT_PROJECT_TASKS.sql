...
IF @wf_task_id IN (1,2,4,5,6,9,12,47,52,56,57,66,67,68,69,72,74,75,83, 86, 87)
BEGIN
	CREATE TABLE #pdf(
...
END --IF @wf_task_id IN (1,2,4,5,6,9,12,47,52,56,57,66,67,68,69,72,74,75,83, 86, 87)
