/****** Object:  StoredProcedure [dbo].[spCREATE_GAR_TASK_ASSIGNMENTS]    Script Date: 04/24/2012 16:02:33 ******/
SET ANSI_NULLS ON
GO
...
insert #gar
    ...
    select wft.id,
        1,
        case when lwft.lsc_gar_form_group_id = 1 then g.grantee_project_id_prev else g.grantee_project_id_curr end,
        case when lwft.lsc_gar_form_group_id = 1 then g.wf_project_id_prev else g.wf_project_id_curr end,
        g.person_id,
        8,
		@open_date ,
		@close_date ,
...
update #gar
    ...
    where lwft.lsc_gar_form_group_id = 2
