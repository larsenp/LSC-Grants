/****** Object:  StoredProcedure [dbo].[spLSC_ASSIGN_GAR_YEAREND]    Script Date: 04/24/2012 16:00:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [dbo].[spLSC_ASSIGN_GAR_YEAREND]
	(@report_year int,
	@open_date datetime,
...
2011 calendar year. It assumes that assignments are being made 
before awards are reflected in the database.
*/
...
insert #gar
    ...
    select wft.id,
        ...
        where wft.wf_task_type_id = 3
            ...
            and lwft.is_pai = 0
			and lwft.lsc_gar_form_group_id = 1
