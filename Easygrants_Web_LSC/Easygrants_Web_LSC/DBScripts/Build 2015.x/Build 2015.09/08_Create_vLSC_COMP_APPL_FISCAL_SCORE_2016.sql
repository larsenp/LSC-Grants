CREATE VIEW [dbo].[vLSC_COMP_APPL_FISCAL_SCORE_2016]
...
SELECT lsc_comp_appl_fiscal_id
	...
	,dbo.fnCEO_COMPENSATION_JUSTIFICATION_SCORE(lsc_comp_appl_fiscal_id) ceo_compensation_justification --I.16 (new)
