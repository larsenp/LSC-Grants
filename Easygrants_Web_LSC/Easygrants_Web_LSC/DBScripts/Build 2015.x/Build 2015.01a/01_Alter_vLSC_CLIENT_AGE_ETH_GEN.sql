ALTER VIEW [dbo].[vLSC_CLIENT_AGE_ETH_GEN]
...
SELECT o.legacy_organization_id recipient_id,
    ...
    isnull(crg.veteran, 0) veteran,
	isnull(crg.non_veteran, 0) non_veteran,
	ca.total_60_ovr,
	cr.white_total,
	cr.black_total,
	cr.hisp_total,
...
SELECT o.legacy_organization_id recipient_id,
	...
	isnull(crg.other_0_17, 0) other_0_17,
	ca.total_0_17,
	isnull(crg.white_18_35, 0) white_18_35,
	isnull(crg.black_18_35, 0) black_18_35,
	isnull(crg.hisp_18_35, 0) hisp_18_35,
	isnull(crg.nat_amr_18_35, 0) nat_amr_18_35,
	isnull(crg.asian_18_35, 0) asian_18_35,
	isnull(crg.other_18_35, 0) other_18_35,
	ca.total_18_35,
	isnull(crg.white_36_59, 0) white_36_59,
	isnull(crg.black_36_59, 0) black_36_59,
	isnull(crg.hisp_36_59, 0) hisp_36_59,
	isnull(crg.nat_amr_36_59, 0) nat_amr_36_59,
	isnull(crg.asian_36_59, 0) asian_36_59,
	isnull(crg.other_36_59, 0) other_36_59,
	ca.total_36_59,
	isnull(crg.white_18_35, 0) + isnull(crg.white_36_59, 0) white_18_59,
	isnull(crg.black_18_35, 0) + isnull(crg.black_36_59, 0) black_18_59,
	isnull(crg.hisp_18_35, 0) + isnull(crg.hisp_36_59, 0) hisp_18_59,
	isnull(crg.nat_amr_18_35, 0) + isnull(crg.nat_amr_36_59, 0) nat_amr_18_59,
	isnull(crg.asian_18_35, 0) + isnull(crg.asian_36_59, 0) asian_18_59,
	isnull(crg.other_18_35, 0) + isnull(crg.other_36_59, 0) other_18_59,
	ca.total_18_59,
	isnull(crg.white_60_ovr, 0) white_60_ovr,
	isnull(crg.black_60_ovr, 0) black_60_ovr,
	isnull(crg.hisp_60_ovr, 0) hisp_60_ovr,
