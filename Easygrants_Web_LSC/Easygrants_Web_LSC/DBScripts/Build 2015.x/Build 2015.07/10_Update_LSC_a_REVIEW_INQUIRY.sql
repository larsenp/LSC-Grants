...
set form_page_key = 'PV_Form_PlaceHolder' -- PV_PAI
where id = 579

Update LSC_a_REVIEW_INQUIRY
set form_page_key = 'PV_Form_PlaceHolder' -- PV_Recruit_PA
where id = 581

Update LSC_a_REVIEW_INQUIRY
set form_page_key = 'PV_Form_PlaceHolder' -- PV_Retain_PA
where id = 582 

Update LSC_a_REVIEW_INQUIRY
set form_page_key = 'PV_Form_PlaceHolder' -- PV_Accomplish_Clients_PAI
where id = 584