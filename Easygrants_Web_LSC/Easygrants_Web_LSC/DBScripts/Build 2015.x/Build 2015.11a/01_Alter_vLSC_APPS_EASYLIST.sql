...
SELECT wfta.wf_task_assignment_id ,
	...
	CASE WHEN ws.subgrantee_name IS NOT NULL THEN ws.subgrantee_name 
		ELSE o_s.organization_name END subgrantee_name
    FROM WF_TASK_ASSIGNMENT wfta
		...
		LEFT JOIN LSC_GRANTEE_PROJECT_SUBGRANT gps ON gp.grantee_project_id = gps.grantee_project_id
		LEFT JOIN ORGANIZATION o_s ON gps.subrecipient_organization_id = o_s.organization_id
