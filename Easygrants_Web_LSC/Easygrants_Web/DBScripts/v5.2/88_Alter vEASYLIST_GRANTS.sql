GO
/****** Object:  View [dbo].[vEASYLIST_GRANTS]    Script Date: 12/22/2008 16:27:09 ******/
SET ANSI_NULLS ON
GO
...
SELECT DISTINCT 
                      ...
                      dbo.ORGANIZATION.common_organization_name, dbo.ORGANIZATION.organization_id, dbo.a_WF_PROJECT.description AS project_name, 
                      Grantee.name_middle, dbo.PERSON_ORGANIZATION_AFFILIATION.institutional_component,
                          (SELECT     email_addr
                            FROM          dbo.EMAIL AS E
