<%@ Control Language="vb" AutoEventWireup="true" CodeBehind="UploadNew.ascx.vb" Inherits="Core_Web.Controls.Sharepoint.cUploadNew" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" EnableViewState="true" %>
...
<%@ Register Tagprefix='Core' tagname='cStaffUploadNew' src='../Sharepoint/StaffUploadNew.ascx' %>
