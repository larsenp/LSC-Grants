...
Public MustInherit Class cstaffUploadSaveALL
	Inherits Core_Web.Controls.Base.cstaffUploadSaveALL
...
'====================================================
	...
	Public Overrides Sub CoreCtl_Load(ByVal sender As System.Object, ByVal e As System.EventArgs)
		...
		If MyBase.WebSession.HasStaffUser Then
			...
			Else
				GetOrginalLinkDocument(UploadCtlSaveAll.SubmittedFileObj)
	...
	Public Sub btnResetSharepoint_Click(ByVal aSrc As Object, ByVal aArgs As EventArgs)
		...
		Dim aSubmittedFileDataObj As cSubmittedFile = UploadCtlSaveAll.SubmittedFileObj
		...
		Try
			...
			If res.Length > 0 Then
				...
				End If
				aDataObject("SubmittedFileID") = UploadCtlSaveAll.SubmittedFileID
