<%@ Control Language="vb" AutoEventWireup="true" Codebehind="UploadSaveAll.ascx.vb" Inherits="Core_Web.Controls.Sharepoint.cUploadSaveAll" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" EnableViewState="true" %>
...
<%@ Register Tagprefix='Core' tagname='cstaffUploadSaveALL' src='../Sharepoint/staffUploadSaveALL.ascx' %>
