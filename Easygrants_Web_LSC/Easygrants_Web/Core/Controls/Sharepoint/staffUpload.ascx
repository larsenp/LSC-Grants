<%@ Control Language="vb" AutoEventWireup="true" Codebehind="staffUpload.ascx.vb" Inherits="Core_Web.Controls.Sharepoint.cstaffUpload" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" EnableViewState="true" %>
