<%@ Control Language="vb" AutoEventWireup="true" Codebehind="staffUploadNew.ascx.vb" Inherits="Core_Web.Controls.Sharepoint.cStaffUploadNew" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" EnableViewState="true" %>
