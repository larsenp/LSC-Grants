...
Public MustInherit Class cStaffUploadNew
	Inherits Core_Web.Controls.Base.cStaffUploadNew
'====================================================
...
'====================================================
	...
	Public Overrides Sub CoreCtl_Load(ByVal sender As System.Object, ByVal e As System.EventArgs)
		...
		If MyBase.WebSession.HasStaffUser Then
			...
			Else
				GetOrginalLinkDocument(UploadNewCtl.SubmittedFileObj)
	...
	Public Sub btnResetSharepoint_Click(ByVal aSrc As Object, ByVal aArgs As EventArgs)
		...
		Dim aSubmittedFileDataObj As cSubmittedFile = UploadNewCtl.SubmittedFileObj
		'Dim aDataObjectNode As XmlNode
		'Dim aFiltersNode As XmlNode
		Dim aDataObject As cDataObject
		If aSubmittedFileDataObj.GetPropertyInt("SharepointConversionStatus") = -1 Then
			CorePage.GetFileUrl(aSubmittedFileDataObj, aSharePointDO, aRemotePDFFileURL, aRemoteOrginalFileURL)
			Dim myCred As New System.Net.NetworkCredential(aSharePointDO("UserName"), aSharePointDO("Password"))
			Dim aWC As WebClient = New WebClient
			aWC.Credentials = myCred
			...
			Try
				...
				If res.Length > 0 Then
					...
					If aDataObject Is Nothing Then
						...
						aDataObject = WebSession.DataObjectFactory.CreateNewDataObjectFromKey("SubmittedFileData")
					End If
					aDataObject("SubmittedFileID") = UploadNewCtl.SubmittedFileID
