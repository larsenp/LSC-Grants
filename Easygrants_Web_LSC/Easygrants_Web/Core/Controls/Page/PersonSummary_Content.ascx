<%@ Control Language="vb" AutoEventWireup="true" Inherits="Core_Web.Controls.Page.cPersonSummary_Content" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<b>View Project Summary</b> button. To return to the previous page, click on the 
<b>Cancel</b> button.</p>
...
<Core:cUserCtlLoader CtlID='ctlPersonRelationships' 
	Src='Core/Controls/PageSection/PersonRelationships_Content.ascx'
	runat='server'/>
