<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Upload1.ascx.vb" Inherits="Core_Web.Controls.Base.cUpload1" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" EnableViewState="true" %>
<%@ Register Tagprefix='Core' tagname='cButton' src='CSSButton.ascx' %>
<%@ Register Tagprefix='Core' tagname='cTextBox' src='TextBox.ascx' %>
<%@ Register Tagprefix='Core' tagname='cstaffUpload' src='staffUpload.ascx' %>
