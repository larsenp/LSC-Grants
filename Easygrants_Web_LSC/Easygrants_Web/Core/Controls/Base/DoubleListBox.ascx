<%@ Control Language="vb" AutoEventWireup="true" Codebehind="DoubleListBox.ascx.vb" Inherits="Core_Web.Controls.Base.cDoubleListBox" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" EnableViewState="true" %>
...
<table border='0' cellspacing='0' cellpadding='0'>
	...
	<tr>
		...
		<td>&nbsp;&nbsp;</td>
		<td width='15%'>
			<table id='tblSort' runat='server'>
				<tr>
					<td>
					<a href='javascript:g<%=ControlAbbrevName%>DblListBox.MoveUp();' style="vertical-align:top" class="CSSButtonStyle" >Up</a>				
					<br><br>
