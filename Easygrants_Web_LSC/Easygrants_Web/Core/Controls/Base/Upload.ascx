...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Upload.ascx.vb" Inherits="Core_Web.Controls.Base.cUpload" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" EnableViewState="true" %>
