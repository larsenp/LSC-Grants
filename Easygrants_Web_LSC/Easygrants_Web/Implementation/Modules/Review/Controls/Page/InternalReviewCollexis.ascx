<%@ Control Language="vb" AutoEventWireup="true" CodeBehind="InternalReviewCollexis.ascx.vb" Inherits="Easygrants_Web.Modules.Review.Controls.Page.cInternalReviewCollexis" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<table id="Table3"  cellspacing='0' cellpadding='2' runat='server' border='0' width='100%'>
    <tr>
        ...
        <td valign="top" width='15%'>
			<Core:cUserCtlLoader ID="CUserCtlLoader3" CtlID='ctlApplicantReportLink' Src='Core/Controls/Base/ReportOutputLink.ascx'
				runat='server' /></td>
    ...
    <tr>
		<td colspan='4'>
			<a href="http://pcdemo.altum.com:8080/cruk/search.jspx?id=<%=GranteeProjectID%>" target='_blank'>Search for similar grants and experts using Collexis</a>
		</td>
	</tr>
</table>
			...
			<DisplayProperties>
				...
				<DisplayProperty PropertyKey='WfTaskOutcomeID'>
					<Control ID='ctlTaskBeenReviewedOutcome'
						...
						<Filters>
							<Argument Type='DataObjectCollection' TypeKey='WfTaskAssignment' DataObjectPropertyKey='WfTask.WorkFlowBuilderList.PrevWfTask.WfTaskID' PropertyKey='WfTaskID' Value='' />
						</Filters>
						<Sort>
