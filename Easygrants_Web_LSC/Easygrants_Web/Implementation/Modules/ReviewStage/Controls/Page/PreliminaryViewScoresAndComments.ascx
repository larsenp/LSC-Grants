<%@ Control Language="vb" AutoEventWireup="true" Inherits="Easygrants_Web.Implementation.Modules.ReviewStage.Controls.Page.cPreliminaryViewScoresAndComments" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
				...
				<DisplayProperty PropertyKey=''>
					<Control ID='btnViewCritique'
						...
						<Action
							PostBack='True'
							Object='DataPresenter'
							Method='ViewCommentsUploadedFile'>
							<Parameters>
