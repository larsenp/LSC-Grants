	...
	<tr>
		<td>
			<Core:cUserCtlLoader 
				...
				Src='Implementation/Modules/ReviewStage/Controls/Page/ScoresandCritiques.ascx' 
				Properties='ReportOuputDefinitionTypeID=1&EditorPageKeyName=ApplicantCommentsEditor'
				runat='server' />
		</td>
	</tr>
</table>	
