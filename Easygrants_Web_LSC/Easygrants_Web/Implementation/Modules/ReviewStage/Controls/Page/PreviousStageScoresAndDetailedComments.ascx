<%@ Control Language="vb" AutoEventWireup="true" Inherits="Easygrants_Web.Implementation.Modules.ReviewStage.Controls.Page.cPreviousStageScoresAndDetailedComments" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<span id='spnConfigXML' visible='false' runat='server'>
	<ModuleSection>
		...
		<DataObject Key='PreviousReviewCycleStage' DataObjectDefinitionKey='ReviewCycleStage' Updatable='False'>
		</DataObject>
		<DataObject Key='ExternalReviewApplicationsListWithoutComments' DataObjectDefinitionKey='ExternalReviewApplicationsListWithoutComments'>
			<Filters>
				...
				<Argument Type='DataObjectCollection' TypeKey='PreviousReviewCycleStage' DataObjectPropertyKey='ReviewCycleStageID' PropertyKey='ReviewCycleStageID'/>
			</Filters>
			<Sort>
