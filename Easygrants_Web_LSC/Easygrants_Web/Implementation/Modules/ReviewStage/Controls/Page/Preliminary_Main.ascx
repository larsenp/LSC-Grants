<%@ Control Language="vb" AutoEventWireup="true" Inherits="Easygrants_Web.Implementation.Modules.ReviewStage.Controls.Page.cPreliminary_Main" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
						...
						<DisplayProperty PropertyKey='' ColumnHeader=' ' HeaderAlign='Center' DataAlign='Center' Width='20%'>
							<Control ID='btnAddComment'
								...
								<Action
									...
									<Parameters>
										<Argument AttributeName='PageKey' Value='ViewPreliminaryScoresAndComments'/>
