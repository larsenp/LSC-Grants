<%@ Control Language="vb" AutoEventWireup="true" Inherits="Easygrants_Web.Implementation.Modules.ReviewStage.Controls.Page.cPreliminary_Main_DetailedComments" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
			...
			<DisplayProperties>	
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
					<Control ID='ctlExternalReviewApplicationsList'
						...
						<DisplayProperty PropertyKey='ApplicantName' ColumnHeader='Primary Contact/PI' Width='14%'>
							<Sortable>	
								<Argument PropertyKey='ApplicantName'/>
							</Sortable>
						</DisplayProperty>
						...
						<DisplayProperty PropertyKey='GPAllReviewWFTA' ColumnHeader='Scores' Width='11%' List='True' ListSeparator=','>
							<DisplayProperties>
						...
						<DisplayProperty PropertyKey='' ColumnHeader=' ' HeaderAlign='Center' DataAlign='Center' Width='20%'>
							<Control ID='btnAddComment'
								Type='cButton' Caption='View Scores and Comments'>
								<Action
									PostBack='True'
									Object='DataPresenter'
									Method='RedirectToModule'>
									<Parameters>
										<Argument AttributeName='PageKey' Value='ViewPreliminaryScoresAndDetailedComments'/>
