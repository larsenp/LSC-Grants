<%@ Control Language="vb" AutoEventWireup="true" Inherits="Easygrants_Web.Modules.Application.Controls.Page.cParticipantUploadAppEditorContent" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
				...
				<DisplayProperty PropertyKey=''>
					<Control ID='ctlUpload'
						...
						<Parameters>
							...
							<Argument Type='DataObject' TypeKey='SubmittedFileID'  PropertyKey='SubmittedFileID' />
