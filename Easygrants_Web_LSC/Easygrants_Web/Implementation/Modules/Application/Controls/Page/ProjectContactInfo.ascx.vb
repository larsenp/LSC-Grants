...
Namespace Easygrants_Web.Implementation.Modules.Application.Controls.Page
    Public MustInherit Class cProjectContactInfo
        ...
        Public Overrides Sub DataPresenter_SaveDataObjects()
			...
			Dim aGranteeProjectPIDOL As cDataObjectList
			...
			aGranteeProjectPIDOL = WebSession.DataObjectFactory.GetDataObjectListWithFilter("GranteeProjectPI", "PersonID", aUser.PersonID.ToString(), _
			 "PITypeID", "1", "IsPrimary", "1", "GranteeProjectID", aUser.GranteeProjectID)
			 If aGranteeProjectPIDOL.Count > 0 Then
				aGranteeProjectPIDOL(0)("OrganizationID") = aOrganizationID
				aGranteeProjectPIDOL(0).SaveData()
			 End If
        End Sub
