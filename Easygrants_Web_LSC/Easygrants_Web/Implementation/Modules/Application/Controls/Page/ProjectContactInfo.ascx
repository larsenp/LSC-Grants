<%@ Control Language="vb" AutoEventWireup="true" Inherits="Easygrants_Web.Implementation.Modules.Application.Controls.Page.cProjectContactInfo"  TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<table border='0' cellspacing='0' cellpadding='0' runat='server' ID="Table3" width='100%'>
	...
	<tr>
		<td></td>
		<td  colspan='3' class="FieldLabel">Prefix</td>	
	</tr>
	...
	<tr>
		<td></td>	
		<td class="FieldLabel">First&nbsp;<%=kDenoteRequiredField%></td>
		<td class="FieldLabel">Middle</td>
		<td class="FieldLabel">Last&nbsp;<%=kDenoteRequiredField%></td>
	</tr>
	...
	<tr>		
		<td></td>
		<td  colspan='3' class="FieldLabel">Suffix</td>	
	</tr>
	<tr><td  colspan='4'>&nbsp;</td></tr>
	<tr>
		<td></td>
	...
	<tr>		
		<td></td>
		<td  colspan='3' class="FieldLabel">Title</td>	
	</tr>	
	<tr><td  colspan='4'>&nbsp;</td></tr>	
