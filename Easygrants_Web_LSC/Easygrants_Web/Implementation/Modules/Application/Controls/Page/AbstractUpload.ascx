<%@ Control Language="vb" AutoEventWireup="true" Inherits="Easygrants_Web.Controls.PageSection.cAbstractUpload" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<table border='0' cellpadding='0' cellspacing='0' runat='server' visible='false'>
	<tr><td><b>Abstract Number</b>&nbsp;&nbsp;</td>
		<td>
			<span runat='server' id='spnAbstract'/>
		</td>
	</tr>
	<tr><td>&nbsp;</td></tr>
</table>
	...
	<ModuleSection>
		<PageContent/>
			<DataObject Key='GranteeProjectInfo' DataObjectDefinitionKey='GranteeProjectInfo' Updatable='True' CreateNew='True'>
				...
				<DisplayProperties>				
					<DisplayProperty PropertyKey='AbstractNumber'>
						<Control ID='ctlAbstract'
							Container='spnAbstract'
							Type='cTextBox'
							Size='15'
							MaxLength='20'>
						</Control>
