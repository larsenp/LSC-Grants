...
<table id="Table2" border='0' cellspacing='0' cellpadding='2' runat='server' width='100%'>
	<tr>
		<td  class="SeparatorHdg"><b>Other Key Personnel</b></td>
	</tr>	
	<tr><td>&nbsp;</td></tr>
	<tr>
		<td>
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey=''>
					<Control ID='ctlAdd'
						...
						<Action
							...
							<Parameters>
								<Argument AttributeName='PageKey' Value='ParticipantKeyPersonnelEditor'/>
				...
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
					<Control ID='ctlDataList'
						...
						<!-- <DisplayProperty PropertyKey='' NewCell='False'>
							<Control ID='btnUploadBiosketch'
								Type='cButton' Caption='Upload Biosketch'
								Image='Upload_Biosketch'>
								<Action
									PostBack='True'
									Object='EventController'
									Method='EventController_NavigateToModulePageKey'>
						...
						<DisplayProperty PropertyKey='' NewCell='False'>
							<Control ID='btnUploadOtherSupport'
								Type='cButton' Caption='Upload Other Support'
								Image=' Upload_Other_Support'>
								<Action
									PostBack='True'
									Object='EventController'
									Method='EventController_NavigateToModulePageKey'>
