<%@ Control Language="vb" AutoEventWireup="true" Inherits="Easygrants_Web.Modules.LOI.Controls.Page.cUploadEditorContent" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
