<%@ Page Language="vb" AutoEventWireup="true" Inherits="Easygrants_Web.Modules.ThirdParty.cModuleContent " CodeBehind="ModuleContent.aspx.vb" %>
...
<span id='spnConfigXML' visible='false' runat='server'>
	<PageConfig>
		<Configurations>
			<!-- currently unused - see comments in ModulePage.cs -->
			<Configuration Key='ReferenceX' Path='Configuration/'/>
		</Configurations>
	</PageConfig>
</span>