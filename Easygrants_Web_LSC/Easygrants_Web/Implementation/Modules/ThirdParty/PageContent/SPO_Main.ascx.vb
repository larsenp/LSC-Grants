...
Public MustInherit Class cSPO_Main
	...
	Public Sub Submit(ByVal aModuleName As String, ByVal aModuleConfig As String, ByVal aPageKey As String)
		...
		If aSelVal = False Then
			...
			dim aList as cDataObjectList = me.WebSession.DataObjectFactory.GetDataObjectListWithFilter("WfTaskAssignment", _
				"GranteeProjectID", aUser.GranteeProjectID.ToString(), "WfTaskID", aUser.WfTaskAssignmentObject.GetRelatedPropertyInt("WfTask.WfParentTaskID").ToString(), "WfTaskRoleID", "1")
			If aList.Count > 0 Then
				aList(0)("WfTaskStatusID") = 1   'incomplete
				aList(0)("WfTaskOutcomeID") = 13  'Application Not Submitted 
			...
			If aSPOList.Count > 0 Then
				...
				aSPOList(0)("WfTaskOutcomeID") = 9  'SPO Not Approved 
			...
			If Not aWfTA Is Nothing Then
				aWfTA("WfTaskOutcomeID") = 2 'set outcome to Submitted
