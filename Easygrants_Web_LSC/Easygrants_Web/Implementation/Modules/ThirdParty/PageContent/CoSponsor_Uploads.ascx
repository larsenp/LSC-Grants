<%@ Control Language="vb" AutoEventWireup="true" Inherits="Easygrants_Web.Implementation.Modules.ThirdParty.PageContent.cCoSponsor_Uploads" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
