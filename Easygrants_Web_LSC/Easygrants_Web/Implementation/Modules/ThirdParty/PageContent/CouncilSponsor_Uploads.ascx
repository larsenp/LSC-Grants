<%@ Control Language="vb" AutoEventWireup="true" Inherits="Implementation.Modules.ThirdParty.PageContent.cCouncilSponsor_Uploads" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" CodeBehind="CouncilSponsor_Uploads.ascx.vb" %>
...
<asp:RegularExpressionValidator id='valRexText' runat='server'
	ControlToValidate='ctlAHAMembershipNo'
	ValidationExpression='^\s?[0-9]{1,13}\s?$'
	ErrorMessage='You may only enter up to 12 digits (no other characters) for a Membership Number.'
	Enabled='true'
	Display='none'/>
...
<!--
<br>Follow the instructions below to upload the Letter of Support in support of your 
sponsorship of this applicant.  Please verify or provide your  membership number. 
<p>
...
<p>
<b>IMPORTANT:</b> When you are finished uploading your files, click the Submit button 
at the bottom of this page to submit your letter of support to the .
<p>
Click on the <b>View PDF</b> button to view the applicants pdf.  If the application is in progress, you may see an incomplete application.
-->
...
<p><b>Membership Number<font color=red>*</font>:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id='spnAHAMembershipNo' runat='server'/>
...
<span id='spnConfigXML' visible='false' runat='server'>
	<ModuleSection>
		...
		<DataObject Key='GranteeProject' DataObjectDefinitionKey='GranteeProject' Updatable='True'>
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='SponsorAHAID'>
					<Control ID='ctlAHAMembershipNo'
						Container='spnAHAMembershipNo'
						Type='cTextBox'
						Size='10'
						MaxLength='12'
						TooLongMessage='Membership Number cannot exceed 12 digits.'>
					</Control>
				</DisplayProperty>	
		...
		<DataObject Key='WfTaskAssignmentReference' DataObjectDefinitionKey='WfTaskAssignmentReference' Updatable='True' CreateNew='True'>
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='AHAMembershipID'>
					<Control ID='ctlAHAMembershipNo'
						Container='spnAHAMembershipNo'
						Type='cTextBox'
						Size='10'
