<%@ Control Language="vb" AutoEventWireup="true" Inherits="Easygrants_Web.Modules.Staff.Controls.PageSection.cCreateAgreementUploadsEditor" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
				...
				<DisplayProperty PropertyKey=''>
					<Control ID='ctlUpload'
						...
						<InstructionHtml>
							...
							<p><b>IMPORTANT:</b> After you have uploaded the file, you must click on the <b>File/Document Name</b> to view the document as it has been converted. If there were any conversion errors, you will view a screen with those details. </p>
						</InstructionHtml>
						<Parameters>
