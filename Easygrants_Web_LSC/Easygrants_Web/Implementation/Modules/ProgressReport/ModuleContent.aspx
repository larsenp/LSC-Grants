<%@ Page Language="vb" AutoEventWireup="true" Inherits="Easygrants_Web.Modules.ProgressReport.cModuleContent "%>
...
<html>
  ...
  <body onload="setTimeout('showAlert(10)', 60000*(<%=TimeOut%> - 10))" MS_POSITIONING="GridLayout">
