...
<%@ Control Language="vb" AutoEventWireup="true"  Inherits="Easygrants_Web.Modules.Staff.Controls.PageSection.cGrantPrimaryContactOrgEditor" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" EnableViewState="false" %>
...
<tr>
	<td><b><%=GetLabel("Organization")%> Name</b>&nbsp;<%=kDenoteRequiredField%></td>
...
<tr>
	<td width='15%'><b>Person Name&nbsp;<%=kDenoteRequiredField%></b></td>	
	<td><span runat='server' id='spnFindPersons' /></td>
</tr>
<tr>
	<td width='15%'></td>	
	<td><Core:cUserCtlLoader CtlID='ctlPerson' Type='cDropDown' runat='server'  Properties='ValidationText=Person Name is required.'/></td>
</tr>
<tr>
<td>&nbsp;</td>
	<td >
			...
			<DisplayProperties>				  
			    <DisplayProperty PropertyKey='GranteeProjectCollaboratingContactTypeID'>
				 ...
				 <DisplayProperty PropertyKey='OrganizationID' PropertyValue='Organization.CommonOrganizationName'>
					<Control ID='ctlOrg' Type='cPopUpSelectorLauncher' RequiredField='True' LabelText='Selected ~~Organization~~ '
						ErrorMessage='~~Organization~~ Name is required.'/>
				</DisplayProperty>
				<DisplayProperty PropertyKey=''>
					<Control ID='btnFindPersons' 
						Type='cButton' 
						Image='Find Persons'						
						Container='spnFindPersons'>							
						<Action								
								PostBack='True'
