<%@ Control Language="vb" AutoEventWireup="true" Inherits="Easygrants_Web.Modules.Staff.Controls.PageContent.cGranteeProjectTaskEditor2" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
					<Control ID='ctlDataList'
						...
						<DisplayProperty PropertyKey='Complete' ColumnHeader='Complete' Format='YesNo'/>
						<DisplayProperty PropertyKey='' ColumnHeader='Options' HeaderColspan='1' HeaderAlign='Center'>
							<Control ID='btnEdit'
								...
								<Action
									...
									<Parameters>
										<Argument AttributeName='PageKey' Value='GranteeProjectOutcomesEditor'/>
