<%@ Control Language="vb" AutoEventWireup="True" Inherits="Easygrants_Web.Modules.Staff.Controls.PageSection.cContact_ReportTasks" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<%@ Register Tagprefix='Core' tagname='NewWindowOpener' src='../../../../../Core/Controls/Base/NewWindowOpener.ascx' %>
<Core:NewWindowOpener id='ctlNewWindowOpener' runat='server'/>
<table border='0' cellspacing='0' cellpadding='2' runat='server' width='100%'>
	<tr>
		<td colspan="4" class="SeparatorHdg"><b>Grantee Reporting Tasks</b></td>
	</tr>	
	<tr><td>&nbsp;</td></tr>
	<tr>
		<td>
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
					<Control ID='ctlList'
						...
						Type='cDataListCtl'
						SeparatorWidth='2'
						NoRecordMessage='This person contact has not been assigned any grantee reporting tasks.'
						MaxPerPage='10'>
						...
						<DisplayProperty PropertyKey='WfProjectTask.Description' ColumnHeader='Grantee Report Task' Width='32%'>
							<Sortable>
						...
						<DisplayProperty PropertyKey='OpenDate' ColumnHeader='Open Date' Format='M/d/yyyy' Width='9%'>
							<Sortable>
						...
						<DisplayProperty PropertyKey='DueDate' ColumnHeader='Due Date' Format='M/d/yyyy' Width='9%'>
							<Sortable>
								<Argument PropertyKey='DueDate'>
								</Argument>
							</Sortable>
						</DisplayProperty>
						<DisplayProperty PropertyKey='WfTaskStatus.WfTaskStatusAbbr' ColumnHeader='Status' Width='9%'>
							<Sortable>
						...
						<DisplayProperty PropertyKey='WfTaskOutcome.WfTaskOutcome' ColumnHeader='Outcome' Width='10%'>
							<Sortable>
