<%@ Control Language="vb" AutoEventWireup="true" CodeBehind="PublicationUploadEditor.ascx.vb" Inherits="Easygrants_Web.Modules.Staff.Controls.PageSection.cPublicationUploadEditor" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
