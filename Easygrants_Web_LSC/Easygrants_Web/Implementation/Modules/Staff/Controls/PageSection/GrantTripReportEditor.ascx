<%@ Control Language="vb" AutoEventWireup="true" CodeBehind="GrantTripReportEditor.ascx.vb" Inherits="Easygrants_Web.Modules.Staff.Controls.PageSection.cGrantTripReportEditor" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<span id='spnConfigXML' visible='false' runat='server'>
	<ModuleSection>
		...
		<DataObject Key='GranteeProjectTrip' DataObjectDefinitionKey='GranteeProjectTrip' Updatable='True' CreateNew='False'>
			<Filters>
				<Argument Type='QueryString' TypeKey='GranteeProjectTripID' PropertyKey='GranteeProjectTripID' />
			</Filters>
		</DataObject>
