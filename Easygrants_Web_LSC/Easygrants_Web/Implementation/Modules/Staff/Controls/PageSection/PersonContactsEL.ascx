<%@ Control Language="vb" AutoEventWireup="true" Codebehind="PersonContactsEL.ascx.vb" Inherits="Easygrants_Web.Modules.Staff.Controls.PageSection.cPersonContactsEL" %>
...
<span id='spnConfigXML' visible='false' runat='server'>
	<ModuleSection>
	<DataObject Key='Filter1' DataObjectDefinitionKey='' Updatable='False'>
			<Filters>
			</Filters>
			<DisplayProperties>
		...
		<DataObject Key='List1' DataObjectDefinitionKey='Person' Updatable='False' GetData='False'>
			<Filters>
			</Filters>
			<Sort>
