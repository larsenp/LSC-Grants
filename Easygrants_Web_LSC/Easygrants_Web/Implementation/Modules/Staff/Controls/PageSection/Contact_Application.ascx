...
<table border='0' cellspacing='0' cellpadding='2' runat='server' width='100%'>
	<tr>
		<td colspan="4" class="SeparatorHdg"><b>Applications</b></td>
	</tr>	
	<tr><td>&nbsp;</td></tr>
</table>
	...
	<ModuleSection>
		<DataObject Key='WfTaskAssignmentList' DataObjectDefinitionKey='WfTaskAssignment'>
			<Filters>
				...
				<Argument Type='' TypeKey='' PropertyKey='WfTaskTypeID' Value='1' Bool='And'>
			...
			<DisplayProperties>	
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
					<Control ID='ctlDataList'
						...
						SeparatorWidth='2'
						NoRecordMessage='No current applications.'
						MaxPerPage='10'>
