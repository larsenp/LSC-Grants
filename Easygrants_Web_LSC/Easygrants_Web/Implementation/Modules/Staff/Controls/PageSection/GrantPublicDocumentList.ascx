<%@ Control Language="vb" AutoEventWireup="true" CodeBehind="GrantPublicDocumentList.ascx.vb" Inherits="Easygrants_Web.Modules.Staff.Controls.PageSection.cGrantPublicDocumentList" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
					...
					<Control ID='btnAdd' 
						...
						Container='spnAdd'>
							<Action
								...
								<Parameters>
									<Argument AttributeName='PageKey' Value='GrantPublicDocumentEditor'/>
									...
									<Argument Type='' TypeKey='FileTypeID' AttributeName='FileTypeID' Value='FileTypeID=59'/>
