<%@ Control Language="vb" AutoEventWireup="true" CodeBehind="GrantPublicDocumentEditor.ascx.vb" Inherits="Easygrants_Web.Modules.Staff.Controls.PageSection.cGrantPublicDocumentEditor" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
				...
				<DisplayProperty PropertyKey=''>
					<Control ID='ctlUpload'
						...
						<InstructionHtml>
							...
							<p><b>IMPORTANT:</b> After you have uploaded the file, you must click the <b>File/Document Name</b> to view the document as it has been converted. If there were any conversion errors, you will view a screen with those details. </p>
						</InstructionHtml>
						<Parameters>
							...
							<Argument PropertyKey='FileExtensionList' Value='doc,xls,ppt,rtf,txt,pdf,docx,xlsx,pptx' ErrorMessage='Error: Only files with extension .doc, .xls, .ppt, .rtf, .txt, .pdf, docx, xlsx or .pptx are allowed.'/>
