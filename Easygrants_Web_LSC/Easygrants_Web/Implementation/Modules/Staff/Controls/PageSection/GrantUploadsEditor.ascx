				...
				<DisplayProperty PropertyKey=''>
					<Control ID='ctlUpload'
						...
						<Parameters>
							...
							<Argument PropertyKey='FileExtensionList' Value='doc,xls,ppt,pdf,rtf,docx,xlsx,pptx' ErrorMessage='Error : Only files with extension .doc, .xls, .ppt, .pdf, .rtf, .docx , .xlsx or .pptx are allowed.'/>
