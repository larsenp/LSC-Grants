...
<table  cellspacing='0' cellpadding='2' runat='server' border='0' width='100%'>
    <tr>
        <td valign="top" width='20%'><b><%=GetLabel("GrantId")%></b></td>
        <td width='25%'><span id='spnNumber' runat='server'/></td>
        <td width='20%'><b><%=GetLabel("LegacyGrantId")%></b></td>
        <td width='35%'><span id='spnLegacyGrantID' runat='server'/></td>
        <td rowspan='6'>
