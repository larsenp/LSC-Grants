<%@ Control Language="vb" AutoEventWireup="True" CodeBehind="BudgetManager_Content.ascx.vb" Inherits="Easygrants_Web.Modules.Staff.Controls.Page.cBudgetManager_Content" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
	...
	<ModuleSection>
		...
		<DataObject Key='BudgetCategoryMain' DataObjectDefinitionKey='BudgetCategory'>
			<Filters>
				...
				<Argument Type='Data' TypeKey='' PropertyKey='HasChild' Value='1' Bool='AND' />
			...
			<DisplayProperties>
					...
					<Control ID='btnAdd' 
						...
						Container='spnAdd'>
							<Action
								...
								Method='AddBudgetCategory'>
								<Parameters>
									<Argument Value='BudgetManagerEditor'/>
				...
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
					<Control ID='ctlDataList'
						...
						<DisplayProperty PropertyKey='ConcatenateLineItems.LineItemsName' ColumnHeader='Line Items' Width='60%' />
						<DisplayProperty PropertyKey=''>
							<Control ID='btnEdit'
								Type='cButton'
								Image='Edit'>
						...
						<DisplayProperty  PropertyKey='' ColumnHeader='' HeaderColspan='1' HeaderAlign='Left' DataAlign='Left' Width='15%'>
							<Parameters>
                                                ...
                                                <RelatedDataObjects>
                                                    <RelatedDataObject DataObjectDefinitionKey='BudgetCategory'>
                                                        <RelationshipProperties>
                                                            <RelationshipProperty parentProperty='BudgetCategoryID' childProperty='ParentID' />
                                                        </RelationshipProperties>
                                                    </RelatedDataObject>
                                                </RelatedDataObjects>
                                            </Parameters>
