<%@ Control Language="vb" AutoEventWireup="True" CodeBehind="FAQ_Staff_View.ascx.vb" Inherits="Easygrants_Web.Modules.Staff.Controls.Page.cFAQ_Staff_View" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<!-- End Embedded XML -->
	<ModuleSection>
		<DataObject Key='FAQ' DataObjectDefinitionKey='FAQ' Updatable='True' CreateNew='True' >	
			<Filters>
               <Argument Type='Data' TypeKey='' PropertyKey='IsStaffAvailable' Value='True'/>
            </Filters>	
			<DisplayProperties>			
