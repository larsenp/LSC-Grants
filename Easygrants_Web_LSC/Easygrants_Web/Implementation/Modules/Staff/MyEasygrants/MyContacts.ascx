<%@ Control Language="vb" AutoEventWireup="true" Inherits="Core_Web.Controls.Base.cDataPresenterCtl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" CodeBehind="MyContacts.ascx.vb" %>
...
<P>
Below are the contacts you've added to your My Contacts page.  Click the link for the contact name to go to the Contact Details page for the selected contact.  Click <B>Remove</B> to remove the selected item from the My Contacts list.
<P>
...
<span id='spnConfigXML' visible='false' runat='server'>
	...
	<ModuleSection>
		<DataObject Key='MyContacts' DataObjectDefinitionKey='MyContacts' Updatable='False'>
			<!--
			<Filters>
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
					...
					<Control ID='ctlMyContacts'
						Container='spnMyContacts'
						Type='cDataListCtl'
						DataObjectDefinitionKey='MyContacts'
						SeparatorWidth='2'
						MaxPerPage='10'>
