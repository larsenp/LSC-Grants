<%@ Control Language="vb" AutoEventWireup="true" Codebehind="ModuleBrowser01.ascx.vb" Inherits="Easygrants_Web.Controls.PageFrame.cModuleBrowser01Ctl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
