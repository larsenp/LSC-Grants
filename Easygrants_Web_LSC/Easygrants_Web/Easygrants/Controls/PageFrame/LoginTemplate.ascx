<%@ Control Language="vb" AutoEventWireup="true" Codebehind="LoginTemplate.ascx.vb" Inherits="Easygrants_Web.Controls.PageFrame.cLoginTemplateCtl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
