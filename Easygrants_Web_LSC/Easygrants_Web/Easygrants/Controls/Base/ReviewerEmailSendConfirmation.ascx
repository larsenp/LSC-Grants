<%@ Control Language="vb" AutoEventWireup="true" Codebehind="ReviewerEmailSendConfirmation.ascx.vb" Inherits="Easygrants_Web.Controls.Base.cReviewerEmailSendConfirmation" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<table border='0' width='100%' cellspacing='0' cellpadding='2' runat='server' id='tabEmailListSource' >
	...
	<tr>
		<td>
			<b>Total Recipient Count:</b>&nbsp;&nbsp;<span id='spnCount' runat='server'/>
		</td>	
		<td></td>	
	</tr>
	<tr>
