...
<tr>
	<td align="middle" class='CompetitionFooter'>
		For technical assistance, please contact us via <span id='spnAncTech' runat='server'/> or phone xxx-xxx-xxxx.
	</td>
</tr>
<tr>
	<td align="middle" class='CompetitionFooter'>
...
<tr>
	<td align="middle" class='CompetitionFooter'>
		Powered by <a target='_blank' href='http://www.altum.com'>Easygrants&reg;</a> v<%= System.Reflection.Assembly.Load(WebAppl.WebAssembly).GetName.Version%> 
		<%If WebAppl.BuildKey <> "Release" Then%>(<%=WebAppl.BuildKey%>)<%End If %> 
	</td>
</tr>
<tr>
	<td align="middle" class='CompetitionFooter'>
		<Core:dbgReleaseBuildDisplay id='ctlReleaseBuildDisplay' runat='server' visible='false'/>
	</td>
</tr>	
</table>
