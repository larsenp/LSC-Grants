<%@ Control Language="vb" AutoEventWireup="true" Inherits="Easygrants_Web.Controls.PageSection.cKeywordEditor" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" CodeBehind="KeywordEditor.ascx.vb" %>
...
<P>Use this page to review and edit keyword information. All fields marked with an asterisk 
(<FONT color=red>*</FONT>)are required. To save your changes, click on the <b>Save</b> button.
To return to the Grant Information page without saving the change, click the <b>Close</b> button.</P>

<!-- Page Content - Controls -->
<table border='0' width='100%' cellspacing='2' cellpadding='2' runat='server'>
	<tr>
		<td colspan="4" class="SeparatorHdg"><b>Grant Keywords</b></td>
	</tr>
	<tr><td>&nbsp;</td></tr>
</table>
<table border='0' cellspacing='0' cellpadding='2' runat='server'>
	...
	<tr><td>&nbsp;</td></tr>
	<tr>
		<td>Area&nbsp;<%=kDenoteRequiredField%></td>
