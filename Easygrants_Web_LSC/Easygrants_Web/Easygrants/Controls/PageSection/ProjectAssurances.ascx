<%@ Control Language="vb" AutoEventWireup="true" Codebehind="ProjectAssurances.ascx.vb" Inherits="Easygrants_Web.Controls.PageSection.cProjectAssurances" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
