...
<tr><td>&nbsp;</td></tr>
<tr><td colspan='2' ><span id = "spnNoUploadTypeMsg" runat="server" visible="false" style="font-weight:bold;color:Red;">Upload Type is required.</span></td></tr>
<tr><td colspan='2'>&nbsp;</td></tr>
<tr><td width="20%"><b>Type</b>&nbsp;<%=kDenoteRequiredField%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp<Core:cUserCtlLoader ID="CUserCtlLoader1" CtlID='ctlType' Type='cDropDown' runat='server' /></td><td><span id="spnUpload" runat="server"></span></td></tr>
<tr><td>&nbsp;</td></tr>
...
<ModuleSection>
		...
		<DataObject Key='WfProjectTaskUpload' DataObjectDefinitionKey='WfProjectTaskUpload' Updatable=''>
			<Filters>
				...
				<Argument Type='Data' TypeKey='' PropertyKey='GeneralUpload' Value='False'/>
			</Filters>
			<Sort>
		...
		<DataObject Key='SubmittedFile' DataObjectDefinitionKey='SubmittedFile' >
			...
			<DisplayProperties>
				<DisplayProperty PropertyKey='DataObjectDefinitionKey'>
					...
					<!--	<DisplayProperty PropertyKey='' ColumnHeader='Options' HeaderColspan='3' HeaderAlign='Center' Width='30%' DataAlign='Center'> -->
							<!-- <Control ID='btnView'
