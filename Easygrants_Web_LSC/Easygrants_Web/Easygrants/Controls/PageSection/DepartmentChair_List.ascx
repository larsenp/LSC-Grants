<%@ Control Language="vb" AutoEventWireup="true" Codebehind="DepartmentChair_List.ascx.vb" Inherits="Easygrants_Web.Controls.PageSection.cDepartmentChair_List" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<table border='0' cellspacing='0' cellpadding='0' runat='server'>
	<tr>
		<td colspan=2>
			<p>
			Possible matches were found for the Department Chair being added.  Listed below are the 
			potential matches.  Click on the contact name to view additional contact information for 
			each potential match.  To use the existing contact, click on the appropriate <b>Select</b> 
			button.  To continue adding the new Department Chair, click on the link labeled 
			<b>Create a New Contact</b>.  Click on <b>Cancel</b> to cancel adding a new Department Chair record.
			<br>If the name of the department chair is correct; however, other information is incorrect, 
	...
	<tr visible='true'>
		<td	valign="top" colspan=2><b>Existing Names Having Email: </b> <%=Email%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
	</tr>
	<tr>
		<td colspan=2>&nbsp;</td>
	</tr>
