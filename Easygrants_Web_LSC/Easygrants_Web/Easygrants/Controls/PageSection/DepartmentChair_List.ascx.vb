...
Public MustInherit Class cDepartmentChair_List
...
'-------------------------------------------------------------
	...
	Public ReadOnly Property GPDC() As String
		Get
			If Not Request.QueryString("GranteeProjectDepartmentChairID") Is Nothing Then 
				Return Request.QueryString("GranteeProjectDepartmentChairID")
			Else
				Return ""
			End If
		End Get
...
'-------------------------------------------------------------
	...
	Public Sub SelectPerson(ByVal aPersonID as String)
		...
		If Not aGPDC Is Nothing Then
			...
			aGPDC("PersonID")  = aPersonDO.GetPropertyInt("PersonID", 0)
			aGPDC("PrefixID") = aPersonDO.GetPropertyInt("PrefixID", 0)
			aGPDC("SuffixID") = aPersonDO.GetPropertyInt("SuffixID", 0)
...
'-------------------------------------------------------------
	...
	Public Sub Cancel()
		...
		If Not aGPDC Is Nothing Then
			...
			EventController_NavigateToModulePageKey("DepartmentChairContactInfo")
		End If		
	End Sub
