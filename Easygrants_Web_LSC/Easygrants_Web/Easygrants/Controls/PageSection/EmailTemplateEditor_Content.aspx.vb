...
Namespace Easygrants_Web.Controls.PageSection
    ...
    Public Class cEmailTemplateEditor_Content
...
#End Region
        ...
        Public Overrides Function LoadPageContent() As Boolean
            ...
            Dim aPageNode As XmlNode = cXMLDoc.FindNode(ModuleNode, "descendant::Page", "Key", "EmailTemplateEditor")
