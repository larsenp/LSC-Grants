<%@ Control Language="vb" AutoEventWireup="true" Inherits="Core_Web.Controls.Base.cDataPresenterCtl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" CodeBehind="RevAddInfoRevEditor.ascx.vb" %>
...
<span id='spnConfigXML' visible='false' runat='server'>
	...
	<ModuleSection>
		<DataObject Key='WfTAReview' DataObjectDefinitionKey='WfTaskAssignmentReview' Updatable='False'>
			<Filters>
		...
		<DataObject Key='ReviewAdditionalInformation' DataObjectDefinitionKey='ReviewAdditionalInformation' Updatable='True' CreateNew='True'>
			...
			<DefaultValues>
				<Argument Type='ModuleUser' TypeKey='WfTaskAssignmentID' PropertyKey='RevWfTaskAssignmentID' Value=''/>
				<Argument Type='DataObjectCollection' TypeKey='WfTAReview' DataObjectPropertyKey='AppWfTaskAssignmentID' PropertyKey='AppWfTaskAssignmentID'/>
			</DefaultValues>
			<DisplayProperties>																		
				<DisplayProperty PropertyKey='Subject'>
					<Control ID='ctlSubject'
						...
						Size='64'
						MaxLength='100'>
						<Validation Type='RegularExpression' ValidationExpression='^[\s-\S]{1,100}$' ErrorMessage='Limit your subject to 100 characters or less.' />
					</Control>
				</DisplayProperty>
				<DisplayProperty PropertyKey='RequestComment'>
					<Control ID='ctlRequestComment'
						Container='spnRequestComment'
						Type='cTextArea'
						Rows='5'
						Cols='50'
						MaxLength='200'>
			...
			<DisplayProperties>
				...
				<DisplayProperty PropertyKey=''>
					<Control ID='ctlRaiseEvent'
						Type='cEventRaiser'>
						<Parameters>
							<Argument Type='' TypeKey='' DataObjectPropertyKey='' EventRaiserProperty='EventID' Value='7' />
