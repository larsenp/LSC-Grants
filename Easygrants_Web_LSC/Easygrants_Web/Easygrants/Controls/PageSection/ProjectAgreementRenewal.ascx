<%@ Control Language="vb" AutoEventWireup="true" Codebehind="ProjectAgreementRenewal.ascx.vb" Inherits="Easygrants_Web.Controls.PageSection.cProjectAgreementRenewal" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
