<%@ Control Language="vb" AutoEventWireup="true" Inherits="Easygrants_Web.Controls.PageSection.cPrincipal_Editor" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<!-- Control Label (for Organization information) -->
		...
		<td>
			<table border='0' cellspacing='0' cellpadding='0'>
				<tr valign='top'>
					...
					<td width='25'>&nbsp;</td> 	
					<td><b><span id='spnIsPrimary' runat='server' visible='false'/>&nbsp;</b>
					</td>
				</tr>
				<tr>
					<td>
	...
	<tr><td>&nbsp;</td></tr>
	<tr>
		<td	valign="top" width="120"><b>Degree&nbsp;</b><%=kDenoteRequiredField%></td>
		<td>
	...
	<tr>
		<td	valign="top" width="120"><b>Title&nbsp;</b><%=kDenoteRequiredField%></td>
		<td>
	...
	<tr>
		<td	valign="top" width="120"><b></b></td>
		<td>
			<span id='spnOrganizationDepartment' runat='server' visible='false'/>
		</td>
	</tr>
	<tr>
			...
			<DisplayProperties>
				...
				<DisplayProperty PropertyKey='FaxNumber'>
					<Control ID='ctlFaxNumber'
						...
						Size='10'
						MaxLength='20'>
						<Validation Type='RegularExpression' ValidationExpression='^\s?[0-9]{0,50}\s?$' ErrorMessage='Fax Number is incorrectly formatted. Use only numbers, no hyphens, commas or parentheses.' />
					</Control>
				</DisplayProperty>	
