...
Public MustInherit Class cReviewCycleTask_List
...
'--------------------------------------------------------
    ...
    Public Sub lnkView_Click(ByVal aSrc As Object, ByVal aEvent As System.EventArgs)
        ctlViewResults.NewWindowURL() = cWebLib.AddQuerystringParameter(me.Request.RawUrl(), "Page", "ApplicantPool") + "&PageFrame=Print"
		ctlViewResults.Open()
