...
Public Class cMaintenanceAlerts_Editor
...
#End Region
	...
	Public Overrides Function LoadPageContent() As Boolean
            ...
            Dim aPageNode As XmlNode = cXMLDoc.FindNode(ModuleNode, "descendant::Page", "Key", "MaintenanceAlertsEditor")
