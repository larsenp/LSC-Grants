<%@ Control Language="vb" AutoEventWireup="true" Codebehind="ProjectAbstract.ascx.vb" Inherits="Easygrants_Web.Controls.PageSection.cProjectAbstract" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
